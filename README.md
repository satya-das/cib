...
# Overview
 ...
 CIB architecture allows one binary component to use classes and functions defined in another binary component that may be built using different compiler. CIB architecture also ensures ABI stability between binary components
...
For details please see [A Simple Class example](examples/simple-class/README.md)
...
For details please see [Runtime polymorphism example](examples/runtime-polymorphism/README.md)
...
For details please see [Virtual Function and ABI Stability example](examples/virtual-function-and-abi-stability/README.md)
...
For details please see [C++ Template Classes example](examples/template-classes/README.md)
