...
struct __zz_cib_Helper<::A, T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_DemoGetMethodTable(__zz_cib_ids::__zz_cib_Class260::__zz_cib_classId))
  {}
  ...
  static auto setValue_3(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::setValue_3>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  ...
  static auto getIntValue_5(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::getIntValue_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto getFloatValue_6(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::getFloatValue_6>(
      __zz_cib_obj
      );
  }
