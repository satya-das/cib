...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_new_2(double Ox, double Oy, double radius) {
    using __zz_cib_newProc = __zz_cib_TYPE* (__zz_cib_decl *) (double Ox, double Oy, double radius);
...
public:
    ...
    static __zz_cib_HANDLE* const& __zz_cib_get_handle(const ::Graphics::Circle* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
