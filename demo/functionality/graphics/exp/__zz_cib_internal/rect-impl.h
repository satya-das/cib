...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_new_2(double left, double bottom, double right, double top) {
    using __zz_cib_newProc = __zz_cib_TYPE* (__zz_cib_decl *) (double left, double bottom, double right, double top);
...
public:
    ...
    static __zz_cib_HANDLE* const& __zz_cib_get_handle(const ::Graphics::Rectangle* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
