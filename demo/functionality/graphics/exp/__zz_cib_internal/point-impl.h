...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_new_2(double x, double y) {
    using __zz_cib_newProc = __zz_cib_TYPE* (__zz_cib_decl *) (double x, double y);
  ...
  static void X_4(__zz_cib_TYPE* __zz_cib_obj, double x) {
    using XProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double x);
  ...
  static void Y_6(__zz_cib_TYPE* __zz_cib_obj, double y) {
    using YProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double y);
...
public:
    ...
    static __zz_cib_HANDLE*& __zz_cib_get_handle(::Point* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
    static __zz_cib_HANDLE* const& __zz_cib_get_handle(const ::Point* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
