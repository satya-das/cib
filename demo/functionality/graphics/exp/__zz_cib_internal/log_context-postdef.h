...
private:
  ...
  static void Line_3(__zz_cib_TYPE* __zz_cib_obj, double x1, double y1, double x2, double y2) {
    using LineProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double x1, double y1, double x2, double y2);
    return instance().invoke<LineProc, __zz_cib_methodid::Line_3>(
      __zz_cib_obj,
      x1, y1, x2, y2);
  }
  static void Rect_4(__zz_cib_TYPE* __zz_cib_obj, double l, double b, double r, double t) {
    using RectProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double l, double b, double r, double t);
    return instance().invoke<RectProc, __zz_cib_methodid::Rect_4>(
      __zz_cib_obj,
      l, b, r, t);
  }
  static void Circle_5(__zz_cib_TYPE* __zz_cib_obj, double cx, double cy, double r) {
    using CircleProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double cx, double cy, double r);
    return instance().invoke<CircleProc, __zz_cib_methodid::Circle_5>(
      __zz_cib_obj,
      cx, cy, r);
  }
  static void Ellipse_6(__zz_cib_TYPE* __zz_cib_obj, double cx, double cy, double a, double b) {
    using EllipseProc = void (__zz_cib_decl *) (__zz_cib_TYPE*, double cx, double cy, double a, double b);
    return instance().invoke<EllipseProc, __zz_cib_methodid::Ellipse_6>(
      __zz_cib_obj,
      cx, cy, a, b);
  }
  static __zz_cib_HANDLE* __zz_cib_cast_to___Graphics__Context_7(__zz_cib_HANDLE* __zz_cib_obj) {
    ...
    return instance().invoke<__zz_cib_cast_to___Graphics__ContextProc, __zz_cib_methodid::__zz_cib_cast_to___Graphics__Context_7>(__zz_cib_obj);
  }
...
public:
    ...
    static __zz_cib_HANDLE*& __zz_cib_get_handle(::Graphics::LogContext* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
    static __zz_cib_HANDLE* const& __zz_cib_get_handle(const ::Graphics::LogContext* __zz_cib_obj) {
      return __zz_cib_obj->__zz_cib_h_;
    }
