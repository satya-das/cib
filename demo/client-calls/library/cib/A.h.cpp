...
struct __zz_cib_Delegator<::A> : public ::A {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl F_3(__zz_cib_Delegatee* __zz_cib_obj) {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl V_5(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->::A::V()
    );
  }
