...
private:
  ...
  static int SetI_3(__zz_cib_TYPE* __zz_cib_obj, __zz_cib_HANDLE* pI) {
    using SetIProc = int (__zz_cib_decl *) (__zz_cib_TYPE*, __zz_cib_HANDLE* pI);
    return instance().invoke<SetIProc, __zz_cib_methodid::SetI_3>(
      __zz_cib_obj,
      pI);
  }
