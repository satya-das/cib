...
struct __zz_cib_Helper<::Value<float>, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::Value<float>>);
...
public:
  ...
  float get() const {
      ...
      __zz_cib_MyHelper::get_3<__zz_cib_::__zz_cib_RValueAbiType_t<float>>(
