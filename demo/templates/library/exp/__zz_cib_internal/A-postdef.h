...
struct __zz_cib_Helper<::A> : public __zz_cib_MethodTableHelper {
  ...
  static auto setValue(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
  ...
  static auto getIntValue(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return instance().invoke<__zz_cib_proc, __zz_cib_methodid::getIntValue>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto getFloatValue(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return instance().invoke<__zz_cib_proc, __zz_cib_methodid::getFloatValue>(
      __zz_cib_obj
      );
  }
