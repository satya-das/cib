...
int A::setValue(const Value<int>& intVal) const {
  return __zz_cib_::__zz_cib_FromAbiType<int>(
    __zz_cib_MyHelper::setValue<__zz_cib_::__zz_cib_AbiType_t<int>>(
...
::Value<int> A::getIntValue() const {
  return __zz_cib_::__zz_cib_FromAbiType<::Value<int>>(
    __zz_cib_MyHelper::getIntValue<__zz_cib_::__zz_cib_AbiType_t<::Value<int>>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
::Value<float> A::getFloatValue() const {
  return __zz_cib_::__zz_cib_FromAbiType<::Value<float>>(
    __zz_cib_MyHelper::getFloatValue<__zz_cib_::__zz_cib_AbiType_t<::Value<float>>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
struct __zz_cib_Delegator<::A> {
  ...
  static __zz_cib_AbiType_t<Value<float>> __zz_cib_decl getFloatValue(const ::A* __zz_cib_obj) {
    return __zz_cib_ToAbiType<Value<float>>(
      __zz_cib_obj->getFloatValue()
    );
  }
  static __zz_cib_AbiType_t<Value<int>> __zz_cib_decl getIntValue(const ::A* __zz_cib_obj) {
