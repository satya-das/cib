...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::Context, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::Context>,
  ...
  Demo::__zz_cib_ImplProxyMap<_ProxyClass> implProxyMap_;
  ...
  static __zz_cib_AbiType __zz_cib_New_0(::Context* __zz_cib_h_) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::Context*, const __zz_cib_MethodTable*);
  ...
  static void __zz_cib_ReleaseProxy(::Context* __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::Context, T>::instanceDeleted_ = false;
}

namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::Circle, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::Circle>,
    "Parameter 'T' is only to delay instantiation of the specialization. It is always the same as first parameter.");
  ...
  static auto Draw_3(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
