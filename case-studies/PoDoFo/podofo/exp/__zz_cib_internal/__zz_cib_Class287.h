...
#include "__zz_cib_internal/__zz_cib_Class283.h"
#include "__zz_cib_internal/__zz_cib_Class284.h"
#include "__zz_cib_internal/__zz_cib_Class285.h"
#include "__zz_cib_internal/__zz_cib_Class286.h"
#include <vector>

namespace __zz_cib_ {
using namespace ::std;
template <typename T>
struct __zz_cib_Helper<::std::vector<unsigned char>, T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class261::__zz_cib_Class287::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
...
template <typename T>
bool __zz_cib_Helper<::std::vector<unsigned char>, T>::instanceDeleted_ = false;
}
namespace std {
template<>
