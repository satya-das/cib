...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfFontType3, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfFontType3>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class447::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfFontType3, T>::instanceDeleted_ = false;
}
