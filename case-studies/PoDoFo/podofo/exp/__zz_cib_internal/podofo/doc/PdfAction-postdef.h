...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfAction, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfAction>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class410::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static auto SetURI_4(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::SetURI_4>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static auto GetURI_5(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetURI_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto HasURI_6(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::HasURI_6>(
      __zz_cib_obj
      );
  }
  template <typename _RT, typename ..._Args>
  static auto SetScript_7(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::SetScript_7>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetScript_8(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetScript_8>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto HasScript_9(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::HasScript_9>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto GetType_10(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetType_10>(
      __zz_cib_obj
      );
  }
  template <typename _RT, typename ..._Args>
  static auto AddToDictionary_11(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::AddToDictionary_11>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfAction, T>::instanceDeleted_ = false;
}
