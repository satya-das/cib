...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfFontConfigWrapper, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfFontConfigWrapper>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class434::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static auto GetFontConfig_3(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetFontConfig_3>(
      __zz_cib_obj
      );
  }
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfFontConfigWrapper, T>::instanceDeleted_ = false;
}
