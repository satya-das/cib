...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfFontType1Base14, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfFontType1Base14>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class446::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static auto EmbedFontFile_3(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::EmbedFontFile_3>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfFontType1Base14, T>::instanceDeleted_ = false;
}
