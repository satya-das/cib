...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfEncodingObjectFactory, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfEncodingObjectFactory>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class419::__zz_cib_classId))
  {}
  ...
  static auto CreateEncoding_2(_Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::CreateEncoding_2>(
      __zz_cib_args...);
  }
