...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfCanvas, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfCanvas>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class335::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static __zz_cib_AbiType __zz_cib_New_0(::PoDoFo::PdfCanvas* __zz_cib_h_) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfCanvas*, const __zz_cib_MethodTable*);
  ...
  static auto GetProcSet_6() {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetProcSet_6>(
      );
  }
  ...
  static auto AddColorResource_7(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::AddColorResource_7>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto AddResource_8(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::AddResource_8>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static void __zz_cib_ReleaseProxy(::PoDoFo::PdfCanvas* __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfCanvas, T>::instanceDeleted_ = false;
}
