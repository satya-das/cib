...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfData, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfData>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class345::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static auto data_6(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::data_6>(
      __zz_cib_obj
      );
  }
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfData, T>::instanceDeleted_ = false;
}
