...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfExtension, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfExtension>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class372::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static auto getNamespace_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::getNamespace_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto getBaseVersion_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::getBaseVersion_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto getLevel_5(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::getLevel_5>(
      __zz_cib_obj
      );
  }
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfExtension, T>::instanceDeleted_ = false;
}
