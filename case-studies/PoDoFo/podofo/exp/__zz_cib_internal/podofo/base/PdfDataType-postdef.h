...
template <typename T>
struct __zz_cib_Helper<::PoDoFo::PdfDataType, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::PoDoFo::PdfDataType>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class333::__zz_cib_Class346::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
  ...
  static __zz_cib_AbiType __zz_cib_New_0(::PoDoFo::PdfDataType* __zz_cib_h_) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::PoDoFo::PdfDataType*, const __zz_cib_MethodTable*);
  ...
  static auto IsDirty_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::IsDirty_3>(
      __zz_cib_obj
      );
  }
  ...
  static auto SetDirty_4(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::SetDirty_4>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT, typename ..._Args>
  static auto SetImmutable_5(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::SetImmutable_5>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetImmutable_6(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetImmutable_6>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto AssertMutable_7(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::AssertMutable_7>(
      __zz_cib_obj
      );
  }
  ...
  static void __zz_cib_ReleaseProxy(::PoDoFo::PdfDataType* __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::PoDoFo::PdfDataType, T>::instanceDeleted_ = false;
}
