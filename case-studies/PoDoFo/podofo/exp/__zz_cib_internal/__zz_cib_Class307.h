...
#include "__zz_cib_internal/__zz_cib_Class303.h"
#include "__zz_cib_internal/__zz_cib_Class304.h"
#include "__zz_cib_internal/__zz_cib_Class305.h"
#include "__zz_cib_internal/__zz_cib_Class306.h"
#include <vector>
...
struct __zz_cib_Helper<::std::vector<::PoDoFo::PdfObject*>, T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class261::__zz_cib_Class307::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
...
public:
  ...
  ::PoDoFo::PdfObject* const * data() const {
    return __zz_cib_::__zz_cib_FromAbiType<::PoDoFo::PdfObject* const *>(
      __zz_cib_MyHelper::data_38<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_Dummy, ::PoDoFo::PdfObject* const *>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
