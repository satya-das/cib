...
template <typename T>
struct __zz_cib_Helper<::__zz_cib_stl_helpers::vector_reverse_iterator<::PoDoFo::PdfObject* const >, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::__zz_cib_stl_helpers::vector_reverse_iterator<::PoDoFo::PdfObject* const >>,
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_CibPoDoFoGetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class306::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
...
template <typename T>
bool __zz_cib_Helper<::__zz_cib_stl_helpers::vector_reverse_iterator<::PoDoFo::PdfObject* const >, T>::instanceDeleted_ = false;
}
