...
#include "__zz_cib_internal/podofo/doc/PdfMemDocument-predef.h"
...
namespace PoDoFo
{
   ...
   *  \see PdfWriter
   */
  class PdfMemDocument : public ::PoDoFo::PdfDocument
  {
  public:
    PdfMemDocument(PdfMemDocument&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfMemDocument, PoDoFo::PdfMemDocument);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfMemDocument-postdef.h"
#endif
