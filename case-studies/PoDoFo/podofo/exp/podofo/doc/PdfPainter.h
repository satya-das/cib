...
#include "__zz_cib_internal/podofo/doc/PdfPainter-predef.h"
...
namespace PoDoFo
{
  ...
  public:
    ...
    *  Use when it's already in resources.
     ...
     */
    EPdfTextRenderingMode GetTextRenderingMode() const;
...
#  endif
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfPainter, PoDoFo::PdfPainter);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfPainter-postdef.h"
#endif
