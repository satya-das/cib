...
#include "__zz_cib_internal/podofo/doc/PdfFontSimple-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfFontSimple : public ::PoDoFo::PdfFont
  {
  public:
    PdfFontSimple(PdfFontSimple&& rhs);
  public:
    ~PdfFontSimple();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontSimple, PoDoFo::PdfFontSimple);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontSimple-postdef.h"
#endif
