...
namespace PoDoFo
{
  ...
  public:
     ...
     */
    virtual PdfRect GetPageSize() const;
  ...
  private:
    __ZZ_CIB_FACADE_CLASS_INTERNALS(PdfPage, PoDoFo::PdfPage);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
