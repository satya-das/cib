...
#include "__zz_cib_internal/podofo/doc/PdfFontMetricsObject-predef.h"
...
namespace PoDoFo
{
  ...
  class PdfObject;
  class PdfVariant;
  class PdfFontMetricsObject : public ::PoDoFo::PdfFontMetrics
  {
  public:
    PdfFontMetricsObject(PdfFontMetricsObject&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontMetricsObject, PoDoFo::PdfFontMetricsObject);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontMetricsObject-postdef.h"
#endif
