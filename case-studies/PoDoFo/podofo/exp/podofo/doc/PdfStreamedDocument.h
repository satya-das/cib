...
#include "__zz_cib_internal/podofo/doc/PdfStreamedDocument-predef.h"
...
namespace PoDoFo
{
   ...
   *  document.Close();
   */
  class PdfStreamedDocument : public ::PoDoFo::PdfDocument
  {
  public:
    PdfStreamedDocument(PdfStreamedDocument&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfStreamedDocument, PoDoFo::PdfStreamedDocument);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfStreamedDocument-postdef.h"
#endif
