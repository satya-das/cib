...
#include "__zz_cib_internal/podofo/doc/PdfFontCID-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfFontCID : public ::PoDoFo::PdfFont
  {
  public:
    PdfFontCID(PdfFontCID&& rhs);
  public:
    ~PdfFontCID();
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfFontCID, PoDoFo::PdfFontCID);
  };
}

#include "__zz_cib_internal/podofo/doc/PdfFontCID-postdef.h"
#endif
