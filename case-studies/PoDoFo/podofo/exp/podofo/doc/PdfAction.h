...
#include "__zz_cib_internal/podofo/doc/PdfAction-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfAction, PoDoFo::PdfAction);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/doc/PdfAction-postdef.h"
#endif
