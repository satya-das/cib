...
#include "__zz_cib_internal/podofo/base/PdfContentsTokenizer-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfContentsTokenizer(PdfContentsTokenizer&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfContentsTokenizer, PoDoFo::PdfContentsTokenizer);
  };
}

#include "__zz_cib_internal/podofo/base/PdfContentsTokenizer-postdef.h"
#endif
