...
#include "__zz_cib_internal/podofo/base/PdfMemoryManagement-predef.h"
...
namespace PoDoFo
{
  ...
  */
  void* podofo_calloc(size_t count, size_t size);
  /**
...
#include "__zz_cib_internal/podofo/base/PdfMemoryManagement-postdef.h"
#endif
