...
#include "__zz_cib_internal/podofo/base/PdfRefCountedInputDevice-predef.h"
...
namespace PoDoFo
{
  ...
  {
  public:
    PdfRefCountedInputDevice(PdfRefCountedInputDevice&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfRefCountedInputDevice, PoDoFo::PdfRefCountedInputDevice);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfRefCountedInputDevice-postdef.h"
#endif
