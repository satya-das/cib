...
#include "__zz_cib_internal/podofo/base/PdfDataType-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfDataType, PoDoFo::PdfDataType);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfDataType-postdef.h"
#endif
