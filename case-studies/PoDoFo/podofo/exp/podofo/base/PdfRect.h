...
#include "__zz_cib_internal/podofo/base/PdfRect-predef.h"
...
namespace PoDoFo
{
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfRect, PoDoFo::PdfRect);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfRect-postdef.h"
#endif
