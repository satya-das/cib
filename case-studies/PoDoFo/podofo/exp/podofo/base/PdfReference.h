...
#include "__zz_cib_internal/podofo/base/PdfReference-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfReference : public ::PoDoFo::PdfDataType
  {
  public:
    PdfReference(PdfReference&& rhs);
  public:
    /**
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfReference, PoDoFo::PdfReference);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfReference-postdef.h"
#endif
