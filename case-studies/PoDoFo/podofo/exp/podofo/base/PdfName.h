...
#include "__zz_cib_internal/podofo/base/PdfName-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfName : public ::PoDoFo::PdfDataType
  {
  public:
    PdfName(PdfName&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfName, PoDoFo::PdfName);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfName-postdef.h"
#endif
