...
#include "__zz_cib_internal/podofo/base/PdfParserObject-predef.h"
...
namespace PoDoFo
{
   ...
   */
  class PdfParserObject : public ::PoDoFo::PdfObject,public ::PoDoFo::PdfTokenizer
  {
  public:
    PdfParserObject(PdfParserObject&& rhs);
  public:
  ...
  private:
    __ZZ_CIB_PROXY_CLASS_INTERNALS(PdfParserObject, PoDoFo::PdfParserObject);
  };
  // -----------------------------------------------------
  // 
  // -----------------------------------------------------
...
#include "__zz_cib_internal/podofo/base/PdfParserObject-postdef.h"
#endif
