...
struct __zz_cib_Helper<::IF, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::IF>);
  ...
  static auto ProtectedVirtual_2(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::ProtectedVirtual_2>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto ProtectedNonVirtual_3(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::ProtectedNonVirtual_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PublicVirtual_5(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PublicVirtual_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PublicNonVirtual_6(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PublicNonVirtual_6>(
      __zz_cib_obj
      );
  }
...
struct __zz_cib_Helper<::A, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto SetIF_3(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::SetIF_3>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetIF_4(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetIF_4>(
      __zz_cib_obj
      );
  }
  static _T* __zz_cib_create_proxy(__zz_cib_AbiType h) {
