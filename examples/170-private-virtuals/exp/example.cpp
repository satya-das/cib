...
int IF::ProtectedVirtual() {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::ProtectedVirtual<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
...
int IF::ProtectedNonVirtual() {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::ProtectedNonVirtual<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
int IF::PublicVirtual() {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::PublicVirtual<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
int IF::PublicNonVirtual() {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::PublicNonVirtual<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
int A::SetIF(::IF* pIF) {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::SetIF<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
...
::IF* A::GetIF() const {
  return __zz_cib_::__zz_cib_FromRValueAbiType<::IF*>(
    __zz_cib_MyHelper::GetIF<__zz_cib_::__zz_cib_RValueAbiType_t<::IF*>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
struct __zz_cib_Delegator<::IF> {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl ProtectedVirtual(::IF* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->ProtectedVirtual()
    );
  }
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl PublicPureVirtual(::IF* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->PublicPureVirtual()
    );
  }
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl ProtectedPureVirtual(::IF* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->ProtectedPureVirtual()
    );
  }
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl PublicVirtual(::IF* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->PublicVirtual()
    );
  }
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl PrivatePureVirtual(::IF* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
