...
struct __zz_cib_Helper<::Example::Outer::Inner::A, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::Example::Outer::Inner::A>);
  ...
  static auto i_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::i_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto f_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::f_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto pi_5(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::pi_5>(
      __zz_cib_obj
      );
  }
