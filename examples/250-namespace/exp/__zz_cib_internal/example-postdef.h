...
private:
  ...
  friend class __zz_cib_HandleHelper<::Example::Outer::Inner::A, __zz_cib_Helper>;
  ...
  static ::Example::Int i(const __zz_cib_TYPE* __zz_cib_obj) {
  ...
  static ::Example::Outer::Inner::A* __zz_cib_create_proxy(__zz_cib_HANDLE* h) {
    return new ::Example::Outer::Inner::A(h);
  }
public:
  static ::Example::Outer::Inner::A __zz_cib_obj_from_handle(__zz_cib_HANDLE* h) {
    return ::Example::Outer::Inner::A(h);
  }
  static __zz_cib_HANDLE*& __zz_cib_get_handle(::Example::Outer::Inner::A* __zz_cib_obj) {
    return __zz_cib_obj->__zz_cib_h_;
  }
  static __zz_cib_HANDLE* const& __zz_cib_get_handle(const ::Example::Outer::Inner::A* __zz_cib_obj) {
    return __zz_cib_obj->__zz_cib_h_;
  }
  static __zz_cib_HANDLE* __zz_cib_release_handle(::Example::Outer::Inner::A* __zz_cib_obj) {
