...
template <typename T>
struct __zz_cib_Helper<::Example::Outer::Inner::A, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::Example::Outer::Inner::A>);
  using __zz_cib_AbiType = typename T::__zz_cib_AbiType;
  using _ProxyClass = T;
  friend class ::Example::Outer::Inner::A;
  using __zz_cib_Methodid = __zz_cib_::__zz_cib_ids::__zz_cib_Class258::__zz_cib_Class259::__zz_cib_Class260::__zz_cib_Class261::__zz_cib_Methodid;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_ExampleGetMethodTable(__zz_cib_ids::__zz_cib_Class258::__zz_cib_Class259::__zz_cib_Class260::__zz_cib_Class261::__zz_cib_classid))
  {}
  ...
  static auto i_3(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::i_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto f_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::f_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto pi_5(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::pi_5>(
      __zz_cib_obj
      );
  }
