...
Example::Outer::Inner::A::A(::Example::Outer::Inner::A const & __zz_cib_param0)
  : Example::Outer::Inner::A(__zz_cib_Helper::__zz_cib_copy(__zz_cib_::Example::Outer::Inner::A::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
Example::Outer::Inner::A::A()
  : Example::Outer::Inner::A(__zz_cib_Helper::__zz_cib_new())
{}

::Example::Int Example::Outer::Inner::A::i() const {
  return __zz_cib_Helper::i(__zz_cib_h_);
}
...
std::unique_ptr<Int> Example::Outer::Inner::A::pi() const {
  return std::unique_ptr<Int>(__zz_cib_Helper::pi(__zz_cib_h_));
}
}}}
