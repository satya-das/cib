...
struct __zz_cib_Helper<::SkRefCntBase, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::SkRefCntBase>);
  ...
  static auto ref_2(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::ref_2>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto unref_3(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::unref_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto internal_dispose_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::internal_dispose_4>(
      __zz_cib_obj
      );
  }
