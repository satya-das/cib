...
namespace __zz_cib_ { namespace SkRefCntBase { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}
...
const __zz_cib_::__zz_cib_MethodTable* __zz_cib_decl __zz_cib_Example_GetMethodTable(std::uint32_t classId)
{
  ...
  case __zz_cib_::SkRefCntBase::__zz_cib_classid:
    return __zz_cib_::SkRefCntBase::__zz_cib_GetMethodTable();
  default:
    return nullptr;
  }
}
