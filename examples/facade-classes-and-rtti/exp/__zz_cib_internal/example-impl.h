...
private:
  ...
  static void F_3(__zz_cib_HANDLE* __zz_cib_obj) {
    using FProc = void (__zz_cib_decl *) (__zz_cib_HANDLE*);
...
private:
  ...
  static __zz_cib_HANDLE* PublicFacade_3(__zz_cib_HANDLE* __zz_cib_obj) {
    using PublicFacadeProc = __zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_HANDLE*);
    return instance().invoke<PublicFacadeProc, __zz_cib_methodid::PublicFacade_3>(
      __zz_cib_obj
      );
  }
  static __zz_cib_HANDLE* PrivateFacade1_4(__zz_cib_HANDLE* __zz_cib_obj) {
    using PrivateFacade1Proc = __zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_HANDLE*);
    return instance().invoke<PrivateFacade1Proc, __zz_cib_methodid::PrivateFacade1_4>(
      __zz_cib_obj
      );
  }
  static __zz_cib_HANDLE* PrivateFacade2_5(__zz_cib_HANDLE* __zz_cib_obj) {
    using PrivateFacade2Proc = __zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_HANDLE*);
