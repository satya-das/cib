...
add_custom_command(
    ...
    COMMAND diff -Bw -U 5 --label ${PREV_TEST_NAME}/cib/example.h.cpp --label ${example}/cib/example.h.cpp ${example_ROOT}/../${PREV_TEST_NAME}/cib/example.h.cpp cib/example.h.cpp >readme-assets/cib.diff || echo "Ignore failure" >/dev/null
