...
struct __zz_cib_Delegator<::Interface> : public ::Interface {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl Gunc(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->Gunc()
    );
  }
  static __zz_cib_AbiType_t<int> __zz_cib_decl Func(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->Func()
    );
  }
