...
struct __zz_cib_Helper<::Interface1> : public __zz_cib_MethodTableHelper {
  ...
  static __zz_cib_AbiType __zz_cib_new(::Interface1* __zz_cib_h_) {
  ...
  static auto disruptVTable(__zz_cib_AbiType __zz_cib_obj) {
...
struct __zz_cib_Helper<::Interface2> : public __zz_cib_MethodTableHelper {
  ...
  static __zz_cib_AbiType __zz_cib_new(::Interface2* __zz_cib_h_) {
...
struct __zz_cib_Helper<::Interface3> : public __zz_cib_MethodTableHelper {
  ...
  static __zz_cib_AbiType __zz_cib_new(::Interface3* __zz_cib_h_) {
...
struct __zz_cib_Helper<::A> : public __zz_cib_MethodTableHelper {
  ...
  static auto SetInterface(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
