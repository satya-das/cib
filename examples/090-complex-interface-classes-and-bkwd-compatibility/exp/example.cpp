...
int Interface1::disruptVTable() {
  return __zz_cib_::__zz_cib_FromRValueAbiType<int>(
    __zz_cib_MyHelper::disruptVTable_5<__zz_cib_::__zz_cib_RValueAbiType_t<int>>(
...
struct __zz_cib_Delegator<::Interface1> {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl disruptVTable_3(::Interface1* __zz_cib_obj) {
...
public:
  ...
  int disruptVTable() override {
    using __zz_cib_proc = __zz_cib_RValueAbiType_t<int>(__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_FromAbiType<int>(
      __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::disruptVTable_5>(
        __zz_cib_h_
      )
    );
  }
...
struct __zz_cib_Delegator<::Interface2> {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl disruptVTable_2(::Interface2* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->disruptVTable()
    );
  }
...
struct __zz_cib_Delegator<::Interface3> {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl disruptVTable_2(::Interface3* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
      __zz_cib_obj->disruptVTable()
    );
  }
