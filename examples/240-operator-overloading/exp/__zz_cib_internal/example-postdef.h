...
struct __zz_cib_Helper<::Example::A> : public __zz_cib_MethodTableHelper {
  ...
  static auto __zz_cib_OperatorLShift(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
  ...
  template <typename _RT, typename ..._Args>
  static auto __zz_cib_OperatorRShift(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
