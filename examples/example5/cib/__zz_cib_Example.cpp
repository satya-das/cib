...
namespace __zz_cib_ { namespace Example { namespace Template { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}}
...
{
  switch(classId) {
  case __zz_cib_::Example::Template::__zz_cib_classid:
    return __zz_cib_::Example::Template::__zz_cib_GetMethodTable();
