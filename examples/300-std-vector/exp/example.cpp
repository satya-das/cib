...
class __zz_cib : public ::C {
  ...
  using __zz_cib_methodid = __zz_cib_::__zz_cib_Class258::__zz_cib_methodid;
  ...
  explicit __zz_cib(__zz_cib_HANDLE* h) : ::C(h), __zz_cib_h_(h) {}
public:
  static ::C* __zz_cib_from_handle(__zz_cib_HANDLE* h) {
...
::C* __zz_cib_::__zz_cib_Class258::__zz_cib_Helper::__zz_cib_create_proxy(__zz_cib_HANDLE* h) {
  switch(__zz_cib_get_class_id(&h)) {
  case __zz_cib_::__zz_cib_Class258::__zz_cib_classid:
    return new ::C(h);
  default: break;
  }
  return ::__zz_cib_::__zz_cib_Class258::__zz_cib_Generic::__zz_cib::__zz_cib_from_handle(h);
}
namespace __zz_cib_ {
namespace __zz_cib_Class258 {
struct __zz_cib_Delegator {
  using __zz_cib_Delegatee = ::C;
  static int __zz_cib_decl f(const ::C* __zz_cib_obj) {
