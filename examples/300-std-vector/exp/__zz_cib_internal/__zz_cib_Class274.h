...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  friend class ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >;
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_Example_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class274::__zz_cib_classid))
  {}
...
template<>
class bidirectional_iterator<::C* const >
{
public:
  bidirectional_iterator(const bidirectional_iterator<::C* const >& __zz_cib_param0)
    : __zz_cib_stl_helpers::bidirectional_iterator<::C* const >(__zz_cib_MyHelper::__zz_cib_copy_0(
  ...
  bidirectional_iterator()
    : __zz_cib_stl_helpers::bidirectional_iterator<::C* const >(__zz_cib_MyHelper::__zz_cib_new_2(
      ))
    {}
  template <typename _ThisClass = bidirectional_iterator<::C* const >>
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::reference operator*() const {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_3<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::reference>>(
  ...
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::pointer operator->() const {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::pointer>(
      __zz_cib_MyHelper::__zz_cib_OperatorArrow_4<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >::pointer>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ...
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >& operator++() {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_5<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  template <typename _ThisClass = bidirectional_iterator<::C* const >>
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const > operator++(int __zz_cib_param0) {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_6<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >& operator--() {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_7<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ...
  ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const > operator--(int __zz_cib_param0) {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_8<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_LazyAbiType<__zz_cib_T, decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
      )
    );
  ...
  template <typename _ThisClass = bidirectional_iterator<::C* const >>
  bool operator==(const ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >& rhs) {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<bool>(
      __zz_cib_MyHelper::__zz_cib_OperatorCmpEq_9<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, bool>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  bool operator!=(const ::__zz_cib_stl_helpers::bidirectional_iterator<::C* const >& rhs) {
    using __zz_cib_T  = std::pair<_ThisClass, bidirectional_iterator<::C* const >>;
    return __zz_cib_::__zz_cib_FromAbiType<bool>(
      __zz_cib_MyHelper::__zz_cib_OperatorNotEq_10<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, bool>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_LazyAbiType<__zz_cib_T, decltype(rhs)>(rhs)
      )
    );
...
private:
  __ZZ_CIB_TEMPLATE_CLASS_INTERNALS(__ZZ_CIB_CLASS_NAME(bidirectional_iterator<::C* const >), __ZZ_CIB_CLASS_NAME(__zz_cib_stl_helpers::bidirectional_iterator<::C* const >));
};
}
