...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_copy(::C* __zz_cib_proxy, __zz_cib_HANDLE const * __zz_cib_param0) {
    using __zz_cib_proc = __zz_cib_TYPE* (__zz_cib_decl *) (::C*, const __zz_cib_MethodTable*, __zz_cib_HANDLE const * __zz_cib_param0);
    return instance().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_copy>(
      __zz_cib_proxy, __zz_cib_get_proxy_method_table(),
      __zz_cib_param0);
  }
  static __zz_cib_TYPE* __zz_cib_new(::C* __zz_cib_proxy, int x) {
    using __zz_cib_proc = __zz_cib_TYPE* (__zz_cib_decl *) (::C*, const __zz_cib_MethodTable*, int x);
  ...
  static int f(const __zz_cib_TYPE* __zz_cib_obj) {
...
private:
  ...
  static __zz_cib_HANDLE* g(const __zz_cib_TYPE* __zz_cib_obj) {
