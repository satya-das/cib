...
struct __zz_cib_Helper<::A, T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_Example_GetMethodTable(__zz_cib_ids::__zz_cib_Class284::__zz_cib_classid))
  {}
  ...
  static auto g_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::g_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto getLargeVector_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::getLargeVector_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  ...
  static auto l_9(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::l_9>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto vl_10(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::vl_10>(
      __zz_cib_obj
      );
  }
