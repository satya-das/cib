...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >, _T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_Example_GetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class276::__zz_cib_classid))
  {}
...
public:
  ...
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::reference operator*() const {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_3<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::pointer operator->() const {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::pointer>(
      __zz_cib_MyHelper::__zz_cib_OperatorArrow_4<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >::pointer>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >& operator++() {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_5<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const > operator++(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorInc_6<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
  ...
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >& operator--() {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >&>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_7<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >&>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
  ::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const > operator--(int __zz_cib_param0) {
      return __zz_cib_::__zz_cib_FromRValueAbiType<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >>(
      __zz_cib_MyHelper::__zz_cib_OperatorDec_8<__zz_cib_::__zz_cib_RValueAbiType_t<::__zz_cib_stl_helpers::bidirectional_reverse_iterator<::C* const >>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
        __zz_cib_::__zz_cib_ToAbiType<decltype(__zz_cib_param0)>(std::move(__zz_cib_param0))
      )
    );
