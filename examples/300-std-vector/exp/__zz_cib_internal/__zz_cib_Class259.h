...
inline const ::std::vector<::C*>::value_type& std::vector<::C*>::operator[](::std::vector<::C*>::size_type __n) const {
  return __zz_cib_::__zz_cib_FromRValueAbiType<const ::std::vector<::C*>::value_type&>(
    __zz_cib_MyHelper::__zz_cib_OperatorIndex_15<__zz_cib_::__zz_cib_RValueAbiType_t<const ::std::vector<::C*>::value_type&>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
      __zz_cib_::__zz_cib_ToAbiType<decltype(__n)>(std::move(__n))
    )
  );
...
inline const ::std::vector<::C*>::value_type& std::vector<::C*>::at(::std::vector<::C*>::size_type __n) const {
  return __zz_cib_::__zz_cib_FromRValueAbiType<const ::std::vector<::C*>::value_type&>(
    __zz_cib_MyHelper::at_16<__zz_cib_::__zz_cib_RValueAbiType_t<const ::std::vector<::C*>::value_type&>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
      __zz_cib_::__zz_cib_ToAbiType<decltype(__n)>(std::move(__n))
    )
  );
...
inline const ::std::vector<::C*>::value_type& std::vector<::C*>::front() const {
  return __zz_cib_::__zz_cib_FromRValueAbiType<const ::std::vector<::C*>::value_type&>(
    __zz_cib_MyHelper::front_17<__zz_cib_::__zz_cib_RValueAbiType_t<const ::std::vector<::C*>::value_type&>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}

inline const ::std::vector<::C*>::value_type& std::vector<::C*>::back() const {
  return __zz_cib_::__zz_cib_FromRValueAbiType<const ::std::vector<::C*>::value_type&>(
    __zz_cib_MyHelper::back_18<__zz_cib_::__zz_cib_RValueAbiType_t<const ::std::vector<::C*>::value_type&>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
