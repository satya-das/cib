...
struct __zz_cib_Helper<::Example::Int, T> : public __zz_cib_MethodTableHelper {
  ...
  static auto __zz_cib_Operator_3(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::__zz_cib_Operator_3>(
      __zz_cib_obj
      );
  }
...
template <typename T>
bool __zz_cib_Helper<::Example::Int, T>::instanceDeleted_ = false;
}
