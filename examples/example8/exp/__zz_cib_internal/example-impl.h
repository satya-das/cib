...
class __zz_cib_Helper : public __zz_cib_::__zz_cib_MethodTableHelper
  , public __zz_cib_::__zz_cib_HandleHelper<::RValueExample, __zz_cib_Helper> {
private:
  ...
  static __zz_cib_HANDLE* __zz_cib_new_1(std::int32_t val) {
    using __zz_cib_newProc = __zz_cib_HANDLE* (__zz_cib_decl *) (std::int32_t val);
    return instance().invoke<__zz_cib_newProc, __zz_cib_methodid::__zz_cib_new_1>(
      val);
  }
  static __zz_cib_HANDLE* __zz_cib_new_2(__zz_cib_HANDLE* __zz_cib_param0) {
    using __zz_cib_newProc = __zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_HANDLE* __zz_cib_param0);
