...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_new_2(int i) {
    using __zz_cib_newProc = __zz_cib_TYPE* (__zz_cib_decl *) (int i);
...
class __zz_cib_Helper : public __zz_cib_MethodTableHelper
  , public __zz_cib_HandleHelper<::B, Example::__zz_cib_null_proxy_mgr, __zz_cib_Helper> {
private:
  using __zz_cib_TYPE = __zz_cib_HANDLE;
  friend class __zz_cib_HandleHelper<::B, Example::__zz_cib_null_proxy_mgr, __zz_cib_Helper>;
  friend class ::B;
  ...
  static void SetA_3(__zz_cib_TYPE* __zz_cib_obj, __zz_cib_HANDLE* pA) {
