...
void A::setPod(Pod& p) {
  __zz_cib_MyHelper::setPod<__zz_cib_::__zz_cib_AbiType_t<void>>(
...
void A::setNonPod1(NonPod1& n) {
  __zz_cib_MyHelper::setNonPod1<__zz_cib_::__zz_cib_AbiType_t<void>>(
    __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
...
void A::setNonPod2(NonPod2& n) {
  __zz_cib_MyHelper::setNonPod2<__zz_cib_::__zz_cib_AbiType_t<void>>(
    __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
...
void A::setNonPod3(NonPod3& n) {
  __zz_cib_MyHelper::setNonPod3<__zz_cib_::__zz_cib_AbiType_t<void>>(
    __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
