...
namespace __zz_cib_ { namespace __zz_cib_Class262 { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}
...
const __zz_cib_::__zz_cib_MethodTable* __zz_cib_decl __zz_cib_Example_GetMethodTable(std::uint32_t classId)
{
  ...
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class262::__zz_cib_classid:
