...
class __zz_cib_Helper : public __zz_cib_::__zz_cib_MethodTableHelper
  , public __zz_cib_::__zz_cib_HandleHelper<::Interface, __zz_cib_Helper> {
private:
  using __zz_cib_TYPE = __zz_cib_HANDLE;
  friend class __zz_cib_::__zz_cib_HandleHelper<::Interface, __zz_cib_Helper>;
  ...
  static int Gunc_4(__zz_cib_TYPE* __zz_cib_obj) {
    using GuncProc = int (__zz_cib_decl *) (__zz_cib_TYPE*);
    return instance().invoke<GuncProc, __zz_cib_methodid::Gunc_4>(
      __zz_cib_obj
      );
  }
