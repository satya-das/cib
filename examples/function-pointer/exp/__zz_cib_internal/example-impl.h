...
private:
  ...
  static int F2_3(__zz_cib_HANDLE* __zz_cib_obj, FPTR_ii fptr) {
    using F2Proc = int (__zz_cib_decl *) (__zz_cib_HANDLE*, FPTR_ii fptr);
    return instance().invoke<F2Proc, __zz_cib_methodid::F2_3>(
      __zz_cib_obj,
      fptr);
  }
