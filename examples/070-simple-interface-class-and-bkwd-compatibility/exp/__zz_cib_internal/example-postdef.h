...
namespace __zz_cib_ {
template <>
struct __zz_cib_Helper<::Interface> : public __zz_cib_MethodTableHelper {
  using __zz_cib_AbiType = typename ::Interface::__zz_cib_AbiType;
  ...
  static __zz_cib_AbiType& __zz_cib_get_handle(::Interface* __zz_cib_obj) {
    return __zz_cib_obj->__zz_cib_h_;
  }
  static __zz_cib_AbiType const& __zz_cib_get_handle(const ::Interface* __zz_cib_obj) {
    return __zz_cib_obj->__zz_cib_h_;
  }
  static __zz_cib_AbiType __zz_cib_release_handle(::Interface* __zz_cib_obj) {
...
struct __zz_cib_Helper<::A> : public __zz_cib_MethodTableHelper {
  ...
  static auto UseInterface(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType, _Args...);
    return instance().invoke<__zz_cib_proc, __zz_cib_methodid::UseInterface>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
