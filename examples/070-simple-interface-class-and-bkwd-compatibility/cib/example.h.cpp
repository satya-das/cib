...
public:
  ...
  int Func() override {
    ...
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Func>(
      __zz_cib_proxy);
  }
  int Gunc() override {
    using __zz_cib_proc = int (__zz_cib_decl *) (__zz_cib_PROXY*);
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::Gunc>(
      __zz_cib_proxy);
  }
  ~__zz_cib() override {
...
static int __zz_cib_decl UseInterface(const __zz_cib_Delegatee* __zz_cib_obj, ::Interface* pInterface) {
