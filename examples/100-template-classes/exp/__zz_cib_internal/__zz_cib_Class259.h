...
struct __zz_cib_Helper<::Example::Value<float>, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::Example::Value<float>>);
...
public:
  ...
  float GetValue() const {
    ...
    return __zz_cib_::__zz_cib_FromAbiType<float>(
      __zz_cib_MyHelper::GetValue_3<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_T, float>>(
