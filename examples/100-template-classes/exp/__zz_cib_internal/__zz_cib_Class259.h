...
inline Example::Value<int>::Value(::Example::Value<int> const & __zz_cib_param0)
  : Example::Value<int>(__zz_cib_::Example::__zz_cib_Class259::__zz_cib_Helper::__zz_cib_copy(__zz_cib_::Example::__zz_cib_Class259::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
inline Example::Value<int>::Value(int x)
  : Example::Value<int>(__zz_cib_::Example::__zz_cib_Class259::__zz_cib_Helper::__zz_cib_new(x))
{}
