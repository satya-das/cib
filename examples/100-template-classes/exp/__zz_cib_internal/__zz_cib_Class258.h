...
private:
  __ZZ_CIB_CLASS_INTERNAL_DEF(__ZZ_CIB_CLASS_NAME(Value<float>), __ZZ_CIB_CLASS_NAME(Example::__zz_cib_Class258));
};
}
...
inline Example::Value<float>::Value(::Example::Value<float> const & __zz_cib_param0)
  : Example::Value<float>(__zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::__zz_cib_copy(__zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
inline Example::Value<float>::Value(float x)
  : Example::Value<float>(__zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::__zz_cib_new(x))
{}

inline float Example::Value<float>::GetValue() const {
  return __zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::GetValue(__zz_cib_h_);
}

inline void Example::Value<float>::SetValue(float x) {
  __zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::SetValue(__zz_cib_h_, x);
}
