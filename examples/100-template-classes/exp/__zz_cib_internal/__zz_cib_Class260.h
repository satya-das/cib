...
private:
  __ZZ_CIB_CLASS_INTERNAL_DEF(__ZZ_CIB_CLASS_NAME(Value<::Example::Int>), __ZZ_CIB_CLASS_NAME(Example::__zz_cib_Class260));
};
}
...
inline Example::Value<::Example::Int>::Value(::Example::Value<::Example::Int> const & __zz_cib_param0)
  : Example::Value<::Example::Int>(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_copy(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
inline Example::Value<::Example::Int>::Value(::Example::Int x)
  : Example::Value<::Example::Int>(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_new(__zz_cib_::Example::Int::__zz_cib_Helper::__zz_cib_handle(x)))
{}
...
__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::GetValue(__zz_cib_h_)
);
}

inline void Example::Value<::Example::Int>::SetValue(::Example::Int x) {
  __zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::SetValue(__zz_cib_h_, __zz_cib_::Example::Int::__zz_cib_Helper::__zz_cib_handle(x));
}
