...
private:
  __ZZ_CIB_CLASS_INTERNAL_DEF(__ZZ_CIB_CLASS_NAME(Value<float>), __ZZ_CIB_CLASS_NAME(Example::__zz_cib_Class260));
};
}
...
inline Example::Value<float>::Value(::Example::Value<float> const & __zz_cib_param0)
  : Example::Value<float>(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_copy(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
inline Example::Value<float>::Value(float x)
  : Example::Value<float>(__zz_cib_::Example::__zz_cib_Class260::__zz_cib_Helper::__zz_cib_new(x))
{}
