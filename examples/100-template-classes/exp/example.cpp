...
void Example::A::Set(::Example::Value<int> const & x) {
  __zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_Set(__zz_cib_h_, __zz_cib_::Example::__zz_cib_Class259::__zz_cib_Helper::__zz_cib_handle(x));
}

::Example::Value<int> Example::A::Get() const {
  return __zz_cib_::Example::__zz_cib_Class259::__zz_cib_Helper::__zz_cib_obj_from_handle(
__zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_Get(__zz_cib_h_)
);
}

void Example::A::SetInt(::Example::Value<::Example::Int> const & y) {
  __zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_SetInt(__zz_cib_h_, __zz_cib_::Example::__zz_cib_Class258::__zz_cib_Helper::__zz_cib_handle(y));
}
...
__zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_GetInt(__zz_cib_h_)
);
}
