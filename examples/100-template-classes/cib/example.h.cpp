...
struct __zz_cib_Delegator<::Example::A> : public ::Example::A {
  ...
  static __zz_cib_RValueAbiType_t<void> __zz_cib_decl Set_3(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const ::Example::Value<int>&> x) {
    __zz_cib_obj->::Example::A::Set(
      __zz_cib_::__zz_cib_FromAbiType<const ::Example::Value<int>&>(x)
    );
  }
  static __zz_cib_RValueAbiType_t<::Example::Value<int>> __zz_cib_decl Get_4(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<::Example::Value<int>>(
      __zz_cib_obj->::Example::A::Get()
    );
  }
  static __zz_cib_RValueAbiType_t<void> __zz_cib_decl SetInt_5(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const ::Example::Value<::Example::Int>&> y) {
    __zz_cib_obj->::Example::A::SetInt(
      __zz_cib_::__zz_cib_FromAbiType<const ::Example::Value<::Example::Int>&>(y)
    );
  }
  static __zz_cib_RValueAbiType_t<::Example::Value<::Example::Int>> __zz_cib_decl GetInt_6(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<::Example::Value<::Example::Int>>(
      __zz_cib_obj->::Example::A::GetInt()
    );
  }
  static __zz_cib_RValueAbiType_t<void> __zz_cib_decl SetFloat_7(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<::Example::Value<float>> f) {
    __zz_cib_obj->::Example::A::SetFloat(
      __zz_cib_::__zz_cib_FromAbiType<::Example::Value<float>>(f)
    );
  }
  static __zz_cib_RValueAbiType_t<::Example::Value<float>> __zz_cib_decl GetFloat_8(const __zz_cib_Delegatee* __zz_cib_obj) {
