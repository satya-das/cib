...
namespace __zz_cib_ { namespace Example { namespace __zz_cib_Class3 { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}}
namespace __zz_cib_ { namespace Example { namespace __zz_cib_Class4 { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}}
...
const __zz_cib_::__zz_cib_MethodTable* __zz_cib_decl __zz_cib_Example_GetMethodTable(std::uint32_t classId)
{
  ...
  case __zz_cib_::Example::__zz_cib_Class3::__zz_cib_classid:
    return __zz_cib_::Example::__zz_cib_Class3::__zz_cib_GetMethodTable();
  case __zz_cib_::Example::__zz_cib_Class4::__zz_cib_classid:
    return __zz_cib_::Example::__zz_cib_Class4::__zz_cib_GetMethodTable();
  default:
    return nullptr;
  }
}
