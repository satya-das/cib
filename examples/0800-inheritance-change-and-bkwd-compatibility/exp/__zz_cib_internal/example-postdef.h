...
struct __zz_cib_Helper<::A, T> : public __zz_cib_MethodTableHelper {
  ...
  static auto AnotherVirtFunc_4(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::AnotherVirtFunc_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  ...
  static auto SomeFunc_5(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::SomeFunc_5>(
      __zz_cib_obj
      );
  }
...
struct __zz_cib_Helper<::I1, T> : public __zz_cib_MethodTableHelper {
  ...
  static auto F_2(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::F_2>(
      __zz_cib_obj
      );
  }
  static auto __zz_cib_Delete_3(__zz_cib_AbiType __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::I1, T>::instanceDeleted_ = false;
}
...
struct __zz_cib_Helper<::I2, T> : public __zz_cib_MethodTableHelper {
  ...
  static auto G_2(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::G_2>(
      __zz_cib_obj
      );
  }
  static auto __zz_cib_Delete_3(__zz_cib_AbiType __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::I2, T>::instanceDeleted_ = false;
}
...
struct __zz_cib_Helper<::B, T> : public __zz_cib_MethodTableHelper {
  ...
  static I1::__zz_cib_AbiType __zz_cib_CastTo__zz_cib_Class260(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = I1::__zz_cib_AbiType (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::__zz_cib_CastTo__zz_cib_Class260>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_CastFrom__zz_cib_Class260(I1::__zz_cib_AbiType  __zz_cib_obj) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (I1::__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::__zz_cib_CastFrom__zz_cib_Class260>(__zz_cib_obj);
  }
  ...
  static I2::__zz_cib_AbiType __zz_cib_CastTo__zz_cib_Class261(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = I2::__zz_cib_AbiType (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::__zz_cib_CastTo__zz_cib_Class261>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_CastFrom__zz_cib_Class261(I2::__zz_cib_AbiType  __zz_cib_obj) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (I2::__zz_cib_AbiType);
...
template <typename T>
bool __zz_cib_Helper<::B, T>::instanceDeleted_ = false;
}
