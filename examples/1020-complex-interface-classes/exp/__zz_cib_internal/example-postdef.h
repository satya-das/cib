...
template <typename T>
bool __zz_cib_Helper<::Interface1, T>::instanceDeleted_ = false;
}
...
template <typename T>
bool __zz_cib_Helper<::Interface2, T>::instanceDeleted_ = false;
}
...
template <typename T>
bool __zz_cib_Helper<::Interface3, T>::instanceDeleted_ = false;
}
