...
public:
  ...
  {}
  Interface(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl, ::Interface const & __zz_cib_param0)
...
struct __zz_cib_Delegator {
  ...
  static ::Interface* __zz_cib_decl __zz_cib_copy(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl, const __zz_cib_Delegatee* __zz_cib_obj) {
    return new __zz_cib_::Interface::__zz_cib_GenericProxy::Interface(proxy, mtbl, *__zz_cib_obj);
  }
