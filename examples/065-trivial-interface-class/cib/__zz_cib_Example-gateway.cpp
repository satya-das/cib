...
namespace __zz_cib_ { namespace Interface { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}
...
{
  switch(classId) {
  case __zz_cib_::Interface::__zz_cib_classid:
    return __zz_cib_::Interface::__zz_cib_GetMethodTable();
  default:
    return nullptr;
  }
}
