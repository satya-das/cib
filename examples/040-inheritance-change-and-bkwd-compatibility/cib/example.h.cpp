...
struct __zz_cib_Delegator<::B> : public ::B {
  ...
  static ::I1* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class260(::B* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::B* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class260(::I1* __zz_cib_obj) {
  ...
  static ::I2* __zz_cib_decl __zz_cib_cast_to___zz_cib_Class261(::B* __zz_cib_obj) {
    return __zz_cib_obj;
  }
  static ::B* __zz_cib_decl __zz_cib_cast_from___zz_cib_Class261(::I2* __zz_cib_obj) {
    return __zz_cib_DownCast<::B*>(__zz_cib_obj);
  }
};
}
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::B>::__zz_cib_cast_to___zz_cib_Class260),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::B>::__zz_cib_cast_from___zz_cib_Class260),
