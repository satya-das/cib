...
class __zz_cib : public ::I1 {
  ...
  using __zz_cib_methodid = __zz_cib_::I1::__zz_cib_GenericProxy::__zz_cib_methodid;
public:
...
class __zz_cib : public ::I2 {
  ...
  using __zz_cib_methodid = __zz_cib_::I2::__zz_cib_GenericProxy::__zz_cib_methodid;
public:
...
class __zz_cib : public ::B {
  ...
  using __zz_cib_methodid = __zz_cib_::B::__zz_cib_GenericProxy::__zz_cib_methodid;
public:
