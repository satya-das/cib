...
struct __zz_cib_Delegator<::A> : public ::A {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl SomeFunc_6(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
...
struct __zz_cib_Delegator<::B> : public ::B {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl G_9(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->::B::G()
    );
  }
  static __zz_cib_AbiType_t<int> __zz_cib_decl F_10(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->::B::F()
    );
  }
  static __zz_cib_AbiType_t<int> __zz_cib_decl AnotherVirtFunc_11(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
