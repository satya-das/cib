...
struct __zz_cib_Helper<::B, _T> : public __zz_cib_MethodTableHelper {
  ...
  static I1::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class262(__zz_cib_AbiType __zz_cib_obj) {
  ...
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class262(I1::__zz_cib_AbiType  __zz_cib_obj) {
  ...
  static I2::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class263(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = I2::__zz_cib_AbiType (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class263>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class263(I2::__zz_cib_AbiType  __zz_cib_obj) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (I2::__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class263>(__zz_cib_obj);
  }
