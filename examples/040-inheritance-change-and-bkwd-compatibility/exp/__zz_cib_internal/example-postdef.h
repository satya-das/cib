...
struct __zz_cib_Helper<::A, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto AnotherVirtFunc_5(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::AnotherVirtFunc_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  ...
  static auto SomeFunc_6(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::SomeFunc_6>(
      __zz_cib_obj
      );
  }
...
namespace __zz_cib_ {
template <typename _T>
struct __zz_cib_Helper<::I1, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::I1>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  static const __zz_cib_MethodTable* __zz_cib_get_proxy_method_table();
  friend class ::I1;
  ...
  static auto F_2(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::F_2>(
      __zz_cib_obj
      );
  }
  static auto __zz_cib_delete_3(__zz_cib_AbiType __zz_cib_obj) {
...
namespace __zz_cib_ {
template <typename _T>
struct __zz_cib_Helper<::I2, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::I2>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  static const __zz_cib_MethodTable* __zz_cib_get_proxy_method_table();
  friend class ::I2;
  ...
  static auto G_2(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::G_2>(
      __zz_cib_obj
      );
  }
  static auto __zz_cib_delete_3(__zz_cib_AbiType __zz_cib_obj) {
...
struct __zz_cib_Helper<::B, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto G_9(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::G_9>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto F_10(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::F_10>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto AnotherVirtFunc_11(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::AnotherVirtFunc_11>(
      __zz_cib_obj
      );
  }
  static I1::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class261(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class261>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class261(I1::__zz_cib_AbiType  __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class261>(__zz_cib_obj);
  }
  static A::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class257(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class257>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class257(A::__zz_cib_AbiType  __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class257>(__zz_cib_obj);
  }
  static I2::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class262(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class262>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class262(I2::__zz_cib_AbiType  __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class262>(__zz_cib_obj);
  }
