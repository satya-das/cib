...
struct __zz_cib_Helper<::A, T> : public __zz_cib_MethodTableHelper {
  ...
  template <typename _RT>
  static auto SomeFunc_5(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::SomeFunc_5>(
      __zz_cib_obj
      );
  }
...
struct __zz_cib_Helper<::B, T> : public __zz_cib_MethodTableHelper {
  ...
  static I1::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class260(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = I1::__zz_cib_AbiType (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_to___zz_cib_Class260>(__zz_cib_obj);
  }
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class260(I1::__zz_cib_AbiType  __zz_cib_obj) {
    using __zz_cib_proc = __zz_cib_AbiType (__zz_cib_decl *) (I1::__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::__zz_cib_cast_from___zz_cib_Class260>(__zz_cib_obj);
  }
  ...
  static I2::__zz_cib_AbiType __zz_cib_cast_to___zz_cib_Class261(__zz_cib_AbiType __zz_cib_obj) {
  ...
  static __zz_cib_AbiType __zz_cib_cast_from___zz_cib_Class261(I2::__zz_cib_AbiType  __zz_cib_obj) {
