...
private:
  using __zz_cib_TYPE = __zz_cib_HANDLE;
  friend class __zz_cib_HandleHelper<::I1, __zz_cib_local_proxy_mgr, __zz_cib_Helper>;
  friend class ::I1;
...
private:
  using __zz_cib_TYPE = __zz_cib_HANDLE;
  friend class __zz_cib_HandleHelper<::I2, __zz_cib_local_proxy_mgr, __zz_cib_Helper>;
  friend class ::I2;
