...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::I1, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::I1>);
  using __zz_cib_AbiType = typename T::__zz_cib_AbiType;
  using _ProxyClass = T;
  static const __zz_cib_MethodTable* __zz_cib_get_proxy_method_table();
  friend class ::I1;
...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::I2, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::I2>);
  using __zz_cib_AbiType = typename T::__zz_cib_AbiType;
  using _ProxyClass = T;
  static const __zz_cib_MethodTable* __zz_cib_get_proxy_method_table();
  friend class ::I2;
