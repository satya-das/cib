...
int A::fE(::E e) const {
  return __zz_cib_Helper::fE(__zz_cib_h_, e);
}

int A::fE(::EC e) const {
  return __zz_cib_Helper::fE_4(__zz_cib_h_, e);
}

int A::fE(::E8 e) const {
  return __zz_cib_Helper::fE_5(__zz_cib_h_, e);
}

int A::fE(::EC16 e) const {
  return __zz_cib_Helper::fE_6(__zz_cib_h_, e);
}
