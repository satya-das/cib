...
add_custom_command(
    ...
    COMMAND diff -Bw -U 1000 --label pub/example.h --label exp/example.h ${example_ROOT}/pub/example.h ${example_ROOT}/exp/example.h >${example_ROOT}/readme-assets/header-diff.diff || echo "Ignore failure" >/dev/null
