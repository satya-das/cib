...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::IF, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::IF>);
  ...
  static __zz_cib_AbiType __zz_cib_New_0(::IF* __zz_cib_h_) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::IF*, const __zz_cib_MethodTable*);
  ...
  static auto ProtectedVirtual_2(__zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::ProtectedVirtual_2>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto ProtectedNonVirtual_3(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::ProtectedNonVirtual_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PublicVirtual_5(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::PublicVirtual_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PublicNonVirtual_6(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::PublicNonVirtual_6>(
      __zz_cib_obj
      );
  }
  ...
  static void __zz_cib_ReleaseProxy(::IF* __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::IF, T>::instanceDeleted_ = false;
}
...
struct __zz_cib_Helper<::A, T> : public __zz_cib_MethodTableHelper {
  ...
  static auto SetIF_3(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::SetIF_3>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto GetIF_4(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_Methodid::GetIF_4>(
      __zz_cib_obj
      );
  }
  static T* __zz_cib_CreateProxy(__zz_cib_AbiType h) {
