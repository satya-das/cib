...
struct __zz_cib_Helper<::I, _T> : public __zz_cib_MethodTableHelper {
  ...
  static _ProxyClass* __zz_cib_findProxy(__zz_cib_AbiType obj, __zz_cib_ClientId clientId) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_findProxyProc, __zz_cib_methodid::__zz_cib_findProxy>(obj, clientId);
  }
  static void __zz_cib_registerProxy(__zz_cib_AbiType obj, __zz_cib_ClientId clientId, _ProxyClass* proxy, __zz_cib_ProxyDeleter deleter) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_registerProxyProc, __zz_cib_methodid::__zz_cib_registerProxy>(obj, clientId, proxy, deleter);
  }
  static void __zz_cib_unregisterProxy(__zz_cib_AbiType obj, __zz_cib_ClientId clientId) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_unregisterProxyProc, __zz_cib_methodid::__zz_cib_unregisterProxy>(obj, clientId);
  }
...
struct __zz_cib_Helper<::A, _T> : public __zz_cib_MethodTableHelper {
  ...
  template <typename _RT>
  static auto g_4(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
  ...
  template <typename _RT>
  static auto c_5(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::c_5>(
      __zz_cib_obj
      );
  }
  template <typename _RT, typename ..._Args>
  static auto d_6(const __zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType, _Args...);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::d_6>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  static _T* __zz_cib_create_proxy(__zz_cib_AbiType h) {
