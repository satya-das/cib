...
const ::I& A::f() const {
  return __zz_cib_::__zz_cib_FromAbiType<const ::I&>(
    __zz_cib_MyHelper::f<__zz_cib_::__zz_cib_AbiType_t<const ::I&>>(
...
const ::I* A::g() const {
  return __zz_cib_::__zz_cib_FromAbiType<const ::I*>(
    __zz_cib_MyHelper::g<__zz_cib_::__zz_cib_AbiType_t<const ::I*>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
::I* A::c() const {
  return __zz_cib_::__zz_cib_FromAbiType<::I*>(
    __zz_cib_MyHelper::c<__zz_cib_::__zz_cib_AbiType_t<::I*>>(
      __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
    )
  );
}
...
void A::d(const I* p) const {
  __zz_cib_MyHelper::d<__zz_cib_::__zz_cib_AbiType_t<void>>(
    __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this),
