...
struct __zz_cib_Helper<::Interface, T> : public __zz_cib_MethodTableHelper {
  ...
  static __zz_cib_AbiType __zz_cib_New_0(::Interface* __zz_cib_h_) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::Interface*, const __zz_cib_MethodTable*);
  ...
  static __zz_cib_AbiType __zz_cib_Copy_1(::Interface* __zz_cib_h_, _Args... __zz_cib_args) {
    using __zz_cib_ProcType = __zz_cib_AbiType (__zz_cib_decl *) (::Interface*, const __zz_cib_MethodTable*, _Args...);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::__zz_cib_Copy_1>(
      __zz_cib_h_, __zz_cib_GetProxyMethodTable(),
      __zz_cib_args...);
  }
  template <typename _RT>
  static auto Func_2(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::Func_2>(
      __zz_cib_obj
      );
  }
  ...
  static void __zz_cib_ReleaseProxy(::Interface* __zz_cib_obj) {
...
template <typename T>
bool __zz_cib_Helper<::Interface, T>::instanceDeleted_ = false;
}
