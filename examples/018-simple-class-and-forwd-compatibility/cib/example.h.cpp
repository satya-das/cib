...
struct __zz_cib_Delegator<::Example::A> : public ::Example::A {
  ...
  static __zz_cib_RValueAbiType_t<int> __zz_cib_decl AnotherFunction_4(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToRValueAbiType<int>(
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::Example::A>::AnotherFunction_4)
  };
