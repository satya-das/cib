...
int Example::A::SomeFunc() {
  return __zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_SomeFunc(__zz_cib_h_);
}

int Example::A::AnotherFunction() {
  return __zz_cib_::Example::A::__zz_cib_Helper::__zz_cib_AnotherFunction(__zz_cib_h_);
}
