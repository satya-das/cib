...
private:
  ...
  static __zz_cib_TYPE* __zz_cib_copy_0(__zz_cib_TYPE* __zz_cib_obj, ::CPoint const * __zz_cib_param0) {
  ...
  static __zz_cib_TYPE* __zz_cib_new_2(__zz_cib_TYPE* __zz_cib_obj, double _x, double _y, double _z) {
  ...
  static ::CPoint const * __zz_cib_OperatorPlusEq_3(__zz_cib_TYPE* __zz_cib_obj, ::CPoint const * p) {
    using __zz_cib_OperatorPlusEqProc = ::CPoint const * (__zz_cib_decl *) (__zz_cib_TYPE*, ::CPoint const * p);
    return instance().invoke<__zz_cib_OperatorPlusEqProc, __zz_cib_methodid::__zz_cib_OperatorPlusEq_3>(
      __zz_cib_obj,
      p);
  }
};
