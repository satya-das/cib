...
struct __zz_cib_Delegator<::CPoint> : public ::CPoint {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_copy_0(::CPoint* __zz_cib_this, const __zz_cib_Delegatee* __zz_cib_obj) {
    return new (__zz_cib_this) __zz_cib_Delegatee(*__zz_cib_obj);
  }
  static void __zz_cib_decl __zz_cib_delete_1(__zz_cib_Delegatee* __zz_cib_obj) {
    __zz_cib_obj->~CPoint();
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_new_2(::CPoint* __zz_cib_this, __zz_cib_AbiType_t<double> _x, __zz_cib_AbiType_t<double> _y, __zz_cib_AbiType_t<double> _z) {
  ...
  static __zz_cib_RValueAbiType_t<const ::CPoint&> __zz_cib_decl __zz_cib_OperatorPlusEq_3(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const ::CPoint&> p) {
...
const __zz_cib_MethodTable* __zz_cib_GetMethodTable() {
  static const __zz_cib_MTableEntry methodArray[] = {
    ...
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::CPoint>::__zz_cib_delete_1),
    reinterpret_cast<__zz_cib_MTableEntry> (&__zz_cib_::__zz_cib_Delegator<::CPoint>::__zz_cib_new_2),
