...
struct __zz_cib_Delegator<::CPoint> : public ::CPoint {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_New_1(::CPoint* __zz_cib_this, __zz_cib_AbiType_t<double> _x, __zz_cib_AbiType_t<double> _y, __zz_cib_AbiType_t<double> _z) {
