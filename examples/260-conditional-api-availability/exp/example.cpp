...
struct __zz_cib_Delegator<::A> {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl DoFunc_0(const ::A* __zz_cib_obj) {
...
struct __zz_cib_Delegator<::P> {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl f3_0(::P* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->f3()
    );
  }
#if  COND // Start of a conditional group, also start of 1st subgroup
  static __zz_cib_AbiType_t<int> __zz_cib_decl f1_1(::P* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->f1()
    );
  }
  static __zz_cib_AbiType_t<int> __zz_cib_decl f2_2(::P* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->f2()
    );
  }
