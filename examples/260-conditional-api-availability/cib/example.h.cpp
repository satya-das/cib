...
class __zz_cib : public ::A {
  ...
  using __zz_cib_methodid = __zz_cib_::A::__zz_cib_GenericProxy::__zz_cib_methodid;
public:
...
class __zz_cib : public ::P {
  ...
  using __zz_cib_methodid = __zz_cib_::P::__zz_cib_GenericProxy::__zz_cib_methodid;
public:
  __ZZ_CIB_DELEGATOR_MEMBERS(__zz_cib, ::P)
  ...
  __zz_cib(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl)
    ...
    , __zz_cib_mtbl_helper(mtbl)
  {}
  __zz_cib(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl, ::P const & __zz_cib_param0)
    : ::P::P(__zz_cib_param0)
    , __zz_cib_proxy(proxy)
    , __zz_cib_mtbl_helper(mtbl)
  {}
  int f3() override {
    ...
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::f3>(
      __zz_cib_proxy);
  }
#if  COND // Start of a conditional group, also start of 1st subgroup
  int f1() override {
    using __zz_cib_proc = int (__zz_cib_decl *) (__zz_cib_PROXY*);
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::f1>(
      __zz_cib_proxy);
  }
  int f2() override {
    using __zz_cib_proc = int (__zz_cib_decl *) (__zz_cib_PROXY*);
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_proc, __zz_cib_methodid::f2>(
      __zz_cib_proxy);
  }
#endif
  ~__zz_cib() override {
...
namespace P {
namespace __zz_cib_Delegator {
using __zz_cib_Delegatee = __zz_cib_::P::__zz_cib_GenericProxy::__zz_cib;
using __zz_cib_ThisClass = __zz_cib_Delegatee;
static ::P* __zz_cib_decl __zz_cib_copy(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl, const __zz_cib_Delegatee* __zz_cib_obj) {
  return new __zz_cib_::P::__zz_cib_GenericProxy::__zz_cib(proxy, mtbl, *__zz_cib_obj);
}
static ::P* __zz_cib_decl __zz_cib_new(__zz_cib_PROXY* proxy, const __zz_cib_MethodTable* mtbl) {
  return new __zz_cib_::P::__zz_cib_GenericProxy::__zz_cib(proxy, mtbl);
}
static void __zz_cib_decl __zz_cib_delete(__zz_cib_Delegatee* __zz_cib_obj) {
  delete __zz_cib_obj;
}
