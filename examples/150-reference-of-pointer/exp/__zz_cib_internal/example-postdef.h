...
struct __zz_cib_Helper<::A, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto VirtualFunction_2(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::VirtualFunction_2>(
      __zz_cib_obj
      );
  }
...
struct __zz_cib_Helper<::B, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto VirtualFunction_3(const __zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (const __zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::VirtualFunction_3>(
      __zz_cib_obj
      );
  }
