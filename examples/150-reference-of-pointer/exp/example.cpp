...
struct __zz_cib_Delegator<::A> {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl VirtualFunction_0(const ::A* __zz_cib_obj) {
...
struct __zz_cib_Delegator<::B> {
  ...
  static __zz_cib_AbiType_t<int> __zz_cib_decl VirtualFunction_0(const ::B* __zz_cib_obj) {
    return __zz_cib_ToAbiType<int>(
      __zz_cib_obj->VirtualFunction()
    );
  }
