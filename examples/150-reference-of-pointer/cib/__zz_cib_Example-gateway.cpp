...
namespace __zz_cib_ { namespace __zz_cib_ExampleGlobal { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}
...
{
  switch(classId) {
  case __zz_cib_::__zz_cib_ids::__zz_cib_ExampleGlobal::__zz_cib_classid:
    return __zz_cib_::__zz_cib_ExampleGlobal::__zz_cib_GetMethodTable();
