...
public:
  ...
  int VirtualFunction() const override {
    using __zz_cib_VirtualFunctionProc = int (__zz_cib_decl *) (const __zz_cib_PROXY*);
    return __zz_cib_get_mtable_helper().invoke<__zz_cib_VirtualFunctionProc, __zz_cib_GenericProxy::__zz_cib_methodid::__zz_cib_VirtualFunction>(
      __zz_cib_proxy);
  }
  ~A() override {
...
static int __zz_cib_decl __zz_cib_VirtualFunction(const __zz_cib_Delegatee* __zz_cib_obj) {
