...
struct __zz_cib_Helper<::RValueExample, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::RValueExample>);
  ...
  static auto GetValue_7(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::GetValue_7>(
      __zz_cib_obj
      );
  }
