...
class __zz_cib_Helper : public __zz_cib_MethodTableHelper
  , public __zz_cib_HandleHelper<::RValueExample, Example::__zz_cib_local_proxy_mgr, __zz_cib_Helper> {
private:
  using __zz_cib_TYPE = __zz_cib_HANDLE;
  friend class __zz_cib_HandleHelper<::RValueExample, Example::__zz_cib_local_proxy_mgr, __zz_cib_Helper>;
  ...
  static __zz_cib_HANDLE* __zz_cib_OperatorEqual(__zz_cib_TYPE* __zz_cib_obj, __zz_cib_HANDLE* rhs) {
    ...
    return instance().invoke<__zz_cib_OperatorEqualProc, __zz_cib_methodid::__zz_cib_OperatorEqual>(
      __zz_cib_obj,
      rhs);
  }
