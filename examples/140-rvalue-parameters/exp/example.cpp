...
RValueExample::RValueExample(std::int32_t val)
  : RValueExample(__zz_cib_Helper::__zz_cib_new(val))
{}

RValueExample::RValueExample(::RValueExample&& __zz_cib_param0)
  : RValueExample(__zz_cib_Helper::__zz_cib_new_2(__zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}

RValueExample::RValueExample(::RValueExample const & __zz_cib_param0)
  : RValueExample(__zz_cib_Helper::__zz_cib_copy(__zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
::RValueExample& RValueExample::operator=(::RValueExample&& rhs) {
  return *__zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_from_handle(
    __zz_cib_Helper::__zz_cib_OperatorEqual(__zz_cib_h_, __zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_handle(rhs))
  );
}

::RValueExample& RValueExample::operator=(::RValueExample const & rhs) {
  return *__zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_from_handle(
    __zz_cib_Helper::__zz_cib_OperatorEqual_5(__zz_cib_h_, __zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_handle(rhs))
  );
}

std::int32_t RValueExample::Set(::RValueExample&& x) {
  return __zz_cib_Helper::Set(__zz_cib_h_, __zz_cib_::RValueExample::__zz_cib_Helper::__zz_cib_handle(x));
}
