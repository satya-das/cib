...
namespace __zz_cib_ { namespace RValueExample { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}
...
{
  switch(classId) {
  case __zz_cib_::RValueExample::__zz_cib_classid:
    return __zz_cib_::RValueExample::__zz_cib_GetMethodTable();
  default:
    return nullptr;
  }
}
