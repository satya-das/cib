...
struct __zz_cib_Delegator<::RValueExample> : public ::RValueExample {
  ...
  static ::RValueExample* __zz_cib_decl __zz_cib_new(__zz_cib_AbiType_t<std::int32_t> val) {
    return new __zz_cib_Delegatee(    __zz_cib_::__zz_cib_FromAbiType<std::int32_t>(val));
  }
  static ::RValueExample* __zz_cib_decl __zz_cib_new_2(__zz_cib_AbiType_t<RValueExample&&> __zz_cib_param0) {
  ...
  static __zz_cib_AbiType_t<RValueExample&> __zz_cib_decl __zz_cib_OperatorEqual(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<RValueExample&&> rhs) {
  ...
  static __zz_cib_AbiType_t<std::int32_t> __zz_cib_decl Set(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<RValueExample&&> x) {
  ...
  static __zz_cib_AbiType_t<std::int32_t> __zz_cib_decl GetValue(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<std::int32_t>(
