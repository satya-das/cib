...
struct __zz_cib_Delegator<::std::vector<::C*>> : public ::std::vector<::C*> {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_New_1(__zz_cib_AbiType_t<size_type> n) {
    return new __zz_cib_Delegatee(    __zz_cib_::__zz_cib_FromAbiType<size_type>(n));
  }
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_New_2(__zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<::C* const&> value) {
    return new __zz_cib_Delegatee(    __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl assign_8(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<::C* const&> u) {
    __zz_cib_obj->::std::vector<::C*>::assign(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
      __zz_cib_::__zz_cib_FromAbiType<::C* const&>(u)
    );
  }
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl begin_9(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::begin()
    );
  }
  static __zz_cib_AbiType_t<const_iterator> __zz_cib_decl begin_10(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_iterator>(
      __zz_cib_obj->::std::vector<::C*>::begin()
    );
  }
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl end_11(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::end()
    );
  }
  static __zz_cib_AbiType_t<const_iterator> __zz_cib_decl end_12(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_iterator>(
      __zz_cib_obj->::std::vector<::C*>::end()
    );
  }
  static __zz_cib_AbiType_t<reverse_iterator> __zz_cib_decl rbegin_13(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<reverse_iterator>(
      __zz_cib_obj->::std::vector<::C*>::rbegin()
    );
  }
  static __zz_cib_AbiType_t<const_reverse_iterator> __zz_cib_decl rbegin_14(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_reverse_iterator>(
      __zz_cib_obj->::std::vector<::C*>::rbegin()
    );
  }
  static __zz_cib_AbiType_t<reverse_iterator> __zz_cib_decl rend_15(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<reverse_iterator>(
      __zz_cib_obj->::std::vector<::C*>::rend()
    );
  }
  static __zz_cib_AbiType_t<const_reverse_iterator> __zz_cib_decl rend_16(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_reverse_iterator>(
      __zz_cib_obj->::std::vector<::C*>::rend()
    );
  }
  static __zz_cib_AbiType_t<const_iterator> __zz_cib_decl cbegin_17(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_iterator>(
      __zz_cib_obj->::std::vector<::C*>::cbegin()
    );
  }
  static __zz_cib_AbiType_t<const_iterator> __zz_cib_decl cend_18(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_iterator>(
      __zz_cib_obj->::std::vector<::C*>::cend()
    );
  }
  static __zz_cib_AbiType_t<const_reverse_iterator> __zz_cib_decl crbegin_19(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_reverse_iterator>(
      __zz_cib_obj->::std::vector<::C*>::crbegin()
    );
  }
  static __zz_cib_AbiType_t<const_reverse_iterator> __zz_cib_decl crend_20(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<const_reverse_iterator>(
  ...
  static __zz_cib_AbiType_t<size_type> __zz_cib_decl size_22(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<size_type>(
      __zz_cib_obj->::std::vector<::C*>::size()
    );
  }
  static __zz_cib_AbiType_t<size_type> __zz_cib_decl max_size_23(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<size_type>(
      __zz_cib_obj->::std::vector<::C*>::max_size()
    );
  }
  static __zz_cib_AbiType_t<size_type> __zz_cib_decl capacity_24(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<size_type>(
      __zz_cib_obj->::std::vector<::C*>::capacity()
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl resize_25(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> sz) {
    __zz_cib_obj->::std::vector<::C*>::resize(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(sz)
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl resize_26(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> sz, __zz_cib_AbiType_t<::C* const&> c) {
    __zz_cib_obj->::std::vector<::C*>::resize(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(sz),
      __zz_cib_::__zz_cib_FromAbiType<::C* const&>(c)
    );
  }
  static __zz_cib_AbiType_t<void> __zz_cib_decl reserve_27(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
  ...
  static __zz_cib_AbiType_t<::std::vector<::C*>::reference> __zz_cib_decl __zz_cib_OperatorIndex_29(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::reference>(
      __zz_cib_obj->::std::vector<::C*>::operator[](
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::C*>::const_reference> __zz_cib_decl __zz_cib_OperatorIndex_30(const __zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::const_reference>(
      __zz_cib_obj->::std::vector<::C*>::operator[](
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::C*>::const_reference> __zz_cib_decl at_31(const __zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::const_reference>(
  ...
  static __zz_cib_AbiType_t<::std::vector<::C*>::reference> __zz_cib_decl at_32(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::reference>(
      __zz_cib_obj->::std::vector<::C*>::at(
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
  ...
  static __zz_cib_AbiType_t<::std::vector<::C*>::reference> __zz_cib_decl front_33(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::reference>(
      __zz_cib_obj->::std::vector<::C*>::front()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::C*>::const_reference> __zz_cib_decl front_34(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::const_reference>(
      __zz_cib_obj->::std::vector<::C*>::front()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::C*>::reference> __zz_cib_decl back_35(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::reference>(
      __zz_cib_obj->::std::vector<::C*>::back()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::C*>::const_reference> __zz_cib_decl back_36(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::C*>::const_reference>(
      __zz_cib_obj->::std::vector<::C*>::back()
    );
  }
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_42(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<::C* const&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<::C* const&>(x)
      )
    );
  }
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_43(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<::C*&&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<::C*&&>(x)
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_44(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<::C* const&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl erase_45(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position) {
    return __zz_cib_ToAbiType<iterator>(
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl erase_46(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> first, __zz_cib_AbiType_t<const_iterator> last) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C*>::erase(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(first),
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(last)
      )
    );
  }
...
struct __zz_cib_Delegator<::std::vector<::C>> : public ::std::vector<::C> {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_New_2(__zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::C&> value) {
    return new __zz_cib_Delegatee(    __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl assign_8(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::C&> u) {
    __zz_cib_obj->::std::vector<::C>::assign(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl resize_26(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> sz, __zz_cib_AbiType_t<const ::C&> c) {
    __zz_cib_obj->::std::vector<::C>::resize(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(sz),
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_42(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<const ::C&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<const ::C&>(x)
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_44(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::C&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::C>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
...
struct __zz_cib_Delegator<::std::vector<::std::list<::C*>>> : public ::std::vector<::std::list<::C*>> {
  ...
  static __zz_cib_AbiType __zz_cib_decl __zz_cib_New_2(__zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::std::list<::C*>&> value) {
    return new __zz_cib_Delegatee(    __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl assign_8(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::std::list<::C*>&> u) {
  ...
  static __zz_cib_AbiType_t<void> __zz_cib_decl resize_26(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> sz, __zz_cib_AbiType_t<const ::std::list<::C*>&> c) {
    __zz_cib_obj->::std::vector<::std::list<::C*>>::resize(
      __zz_cib_::__zz_cib_FromAbiType<size_type>(sz),
  ...
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::reference> __zz_cib_decl __zz_cib_OperatorIndex_29(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::operator[](
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::const_reference> __zz_cib_decl __zz_cib_OperatorIndex_30(const __zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::const_reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::operator[](
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::const_reference> __zz_cib_decl at_31(const __zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::const_reference>(
  ...
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::reference> __zz_cib_decl at_32(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<size_type> n) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::at(
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n)
      )
  ...
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::reference> __zz_cib_decl front_33(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::front()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::const_reference> __zz_cib_decl front_34(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::const_reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::front()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::reference> __zz_cib_decl back_35(__zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::back()
    );
  }
  static __zz_cib_AbiType_t<::std::vector<::std::list<::C*>>::const_reference> __zz_cib_decl back_36(const __zz_cib_Delegatee* __zz_cib_obj) {
    return __zz_cib_ToAbiType<::std::vector<::std::list<::C*>>::const_reference>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::back()
    );
  }
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_42(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<const ::std::list<::C*>&> x) {
    return __zz_cib_ToAbiType<iterator>(
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_43(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<::std::list<::C*>&&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<::std::list<::C*>&&>(x)
  ...
  static __zz_cib_AbiType_t<iterator> __zz_cib_decl insert_44(__zz_cib_Delegatee* __zz_cib_obj, __zz_cib_AbiType_t<const_iterator> position, __zz_cib_AbiType_t<size_type> n, __zz_cib_AbiType_t<const ::std::list<::C*>&> x) {
    return __zz_cib_ToAbiType<iterator>(
      __zz_cib_obj->::std::vector<::std::list<::C*>>::insert(
        __zz_cib_::__zz_cib_FromAbiType<const_iterator>(position),
        __zz_cib_::__zz_cib_FromAbiType<size_type>(n),
