...
public:
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::std::list<::C*>>*, vector_iterator<::std::list<::C*>>*>>
  ::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>& operator+=(difference_type n) {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>&>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::std::list<::C*>>*, vector_iterator<::std::list<::C*>>*>>
  ::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>> operator+(difference_type n) const {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::std::list<::C*>>*, vector_iterator<::std::list<::C*>>*>>
  difference_type operator-(const ::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>& rhs) {
