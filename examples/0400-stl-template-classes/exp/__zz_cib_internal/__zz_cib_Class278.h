...
struct __zz_cib_Helper<::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>, T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_ExampleGetMethodTable(__zz_cib_ids::__zz_cib_Class256::__zz_cib_Class278::__zz_cib_classId))
  {}
  ~__zz_cib_Helper() {
...
template <typename T>
bool __zz_cib_Helper<::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>, T>::instanceDeleted_ = false;
}
...
public:
  ...
  ::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>::const_reference operator*() const {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>::const_reference>(
      __zz_cib_MyHelper::__zz_cib_OperatorMul_5<__zz_cib_::__zz_cib_LazyAbiType_t<__zz_cib_Dummy, ::__zz_cib_stl_helpers::vector_iterator<::std::list<::C*>>::const_reference>>(
        __zz_cib_::__zz_cib_ToAbiType<decltype(this)>(this)
      )
    );
  }
