...
public:
  ...
  {}
  template <typename __zz_cib_Dummy = std::pair<vector<::C>*, vector<::C>*>>
  vector(size_type n, const ::C& value)
  ...
  template <typename __zz_cib_Dummy = std::pair<vector<::C>*, vector<::C>*>>
  void assign(size_type n, const ::C& u) {
  ...
  template <typename __zz_cib_Dummy = std::pair<vector<::C>*, vector<::C>*>>
  void resize(size_type sz, const ::C& c) {
  ...
  template <typename __zz_cib_Dummy = std::pair<vector<::C>*, vector<::C>*>>
  iterator insert(const_iterator position, const ::C& x) {
    return __zz_cib_::__zz_cib_FromAbiType<iterator>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector<::C>*, vector<::C>*>>
  iterator insert(const_iterator position, size_type n, const ::C& x) {
    return __zz_cib_::__zz_cib_FromAbiType<iterator>(
