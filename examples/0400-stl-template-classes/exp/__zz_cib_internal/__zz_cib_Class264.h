...
public:
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::C* const >*, vector_iterator<::C* const >*>>
  ::__zz_cib_stl_helpers::vector_iterator<::C* const >& operator+=(difference_type n) {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<::C* const >&>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::C* const >*, vector_iterator<::C* const >*>>
  ::__zz_cib_stl_helpers::vector_iterator<::C* const > operator+(difference_type n) const {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_iterator<::C* const >>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_iterator<::C* const >*, vector_iterator<::C* const >*>>
  difference_type operator-(const ::__zz_cib_stl_helpers::vector_iterator<::C* const >& rhs) {
