...
public:
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_reverse_iterator<::C>*, vector_reverse_iterator<::C>*>>
  ::__zz_cib_stl_helpers::vector_reverse_iterator<::C>& operator+=(difference_type n) {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_reverse_iterator<::C>&>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_reverse_iterator<::C>*, vector_reverse_iterator<::C>*>>
  ::__zz_cib_stl_helpers::vector_reverse_iterator<::C> operator+(difference_type n) const {
    return __zz_cib_::__zz_cib_FromAbiType<::__zz_cib_stl_helpers::vector_reverse_iterator<::C>>(
  ...
  template <typename __zz_cib_Dummy = std::pair<vector_reverse_iterator<::C>*, vector_reverse_iterator<::C>*>>
  difference_type operator-(const ::__zz_cib_stl_helpers::vector_reverse_iterator<::C>& rhs) {
