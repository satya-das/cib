...
add_custom_command(
    ...
    COMMAND diff -Bw --label ${PREV_TEST_NAME}/src/example-client.cpp --label ${NEW_TEST_NAME}/src/example-client.cpp ${example_ROOT}/../${PREV_TEST_NAME}/src/example-client.cpp ${example_ROOT}/src/example-client.cpp >${example_ROOT}/readme-assets/client-diff.diff || echo "Ignore failure" >/dev/null
