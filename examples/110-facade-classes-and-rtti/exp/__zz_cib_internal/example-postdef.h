...
struct __zz_cib_Helper<::Facade, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::Facade>);
...
namespace __zz_cib_ {
template <typename _T>
struct __zz_cib_Helper<::PublicFacadeImpl, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::PublicFacadeImpl>);
  using __zz_cib_AbiType = typename _T::__zz_cib_AbiType;
  using _ProxyClass = _T;
  static const __zz_cib_MethodTable* __zz_cib_get_proxy_method_table();
...
struct __zz_cib_Helper<::A, _T> : public __zz_cib_MethodTableHelper {
  ...
  static auto PublicFacade_3(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PublicFacade_3>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PrivateFacade1_4(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PrivateFacade1_4>(
      __zz_cib_obj
      );
  }
  template <typename _RT>
  static auto PrivateFacade2_5(__zz_cib_AbiType __zz_cib_obj) {
    using __zz_cib_proc = _RT (__zz_cib_decl *) (__zz_cib_AbiType);
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::PrivateFacade2_5>(
      __zz_cib_obj
      );
  }
  static _T* __zz_cib_create_proxy(__zz_cib_AbiType h) {
