...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::RValueExample, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::RValueExample>,
  ...
  static auto Set_6(__zz_cib_AbiType __zz_cib_obj, _Args... __zz_cib_args) {
    using __zz_cib_ProcType = _RT (__zz_cib_decl *) (__zz_cib_AbiType, _Args...);
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::Set_6>(
      __zz_cib_obj,
      __zz_cib_args...);
  }
  ...
  static auto GetValue_7(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_GetMethodTable().Invoke<__zz_cib_ProcType, __zz_cib_MethodId::GetValue_7>(
      __zz_cib_obj
      );
  }
...
template <typename T>
bool __zz_cib_Helper<::RValueExample, T>::instanceDeleted_ = false;
}
