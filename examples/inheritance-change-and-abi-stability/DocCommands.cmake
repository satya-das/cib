...
add_custom_command(
    ...
    # COMMAND diff -Bw -u1000 --label pub/example.h --label exp/example.h pub/example.h exp/example.h >${example_ROOT}/../readme-assets/${example}/header-diff.diff || echo "Ignore failure" >/dev/null
