...
#include "__zz_cib_BaseTemplateInterfaceTests-smart-ptr-detection.h"
...
#if __has_include("__zz_cib_BaseTemplateInterfaceTests-value-types.h")
#  include "__zz_cib_BaseTemplateInterfaceTests-value-types.h"
#endif
