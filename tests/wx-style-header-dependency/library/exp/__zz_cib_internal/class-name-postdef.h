...
namespace __zz_cib_ {
template <typename T>
struct __zz_cib_Helper<::wxClassBase, T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<T, ::wxClassBase>,
  ...
  friend class ::wxClassBase;
  using __zz_cib_MethodId = __zz_cib_::__zz_cib_ids::__zz_cib_Class258::__zz_cib_MethodId;

  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_wxStyleHeaderDependencyTestsGetMethodTable(__zz_cib_ids::__zz_cib_Class258::__zz_cib_classId))
  {}
  ...
  static auto Func_3(const __zz_cib_AbiType __zz_cib_obj) {
