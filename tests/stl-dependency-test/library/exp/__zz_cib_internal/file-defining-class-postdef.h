...
struct __zz_cib_Helper<::ExampleClass, _T> : public __zz_cib_MethodTableHelper {
  ...
  __zz_cib_Helper()
    : __zz_cib_MethodTableHelper(
      __zz_cib_StlDependencyTest_GetMethodTable(__zz_cib_ids::__zz_cib_Class263::__zz_cib_classid))
  {}
  ...
  static auto value_4(const __zz_cib_AbiType __zz_cib_obj) {
    ...
    return __zz_cib_mtbl().invoke<__zz_cib_proc, __zz_cib_methodid::value_4>(
      __zz_cib_obj
      );
  }
