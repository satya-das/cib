...
struct __zz_cib_Helper<::TemplateClassWithOneParam<int>, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::TemplateClassWithOneParam<int>>);
...
{
public:
  TemplateClassWithOneParam(const ::TemplateClassWithOneParam<int>& __zz_cib_param0)
...
private:
  __ZZ_CIB_TEMPLATE_CLASS_INTERNALS(__ZZ_CIB_CLASS_NAME(TemplateClassWithOneParam<int>), __ZZ_CIB_CLASS_NAME(TemplateClassWithOneParam<int>));
};
