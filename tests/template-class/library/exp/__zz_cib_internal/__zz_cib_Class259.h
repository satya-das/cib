...
struct __zz_cib_Helper<::TemplateClassWithTwoParamsAndDefaultParameter<int, int>, _T> : public __zz_cib_MethodTableHelper {
  static_assert(std::is_same_v<_T, ::TemplateClassWithTwoParamsAndDefaultParameter<int, int>>);
