...
template <typename _T>
auto __zz_cib_ToRValueAbiType(__zz_cib_ClientTypeToAbiType<_T> obj)
{
  return obj.convert();
}

template <typename _T>
using __zz_cib_RValueAbiType_t = decltype((static_cast<__zz_cib_ClientTypeToAbiType<_T>*>(nullptr))->convert());
