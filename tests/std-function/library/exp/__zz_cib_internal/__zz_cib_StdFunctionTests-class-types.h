...
#include "__zz_cib_StdFunctionTests-smart-ptr-detection.h"
...
#if __has_include("__zz_cib_StdFunctionTests-value-types.h")
#  include "__zz_cib_StdFunctionTests-value-types.h"
#endif
