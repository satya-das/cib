...
#include "__zz_cib_StdFunctionTests-export.h"
#include "__zz_cib_StdFunctionTests-ids.h"
#include "__zz_cib_StdFunctionTests-mtable.h"
...
namespace __zz_cib_ { namespace __zz_cib_Class261 { const __zz_cib_MethodTable* __zz_cib_GetMethodTable(); }}

extern "C" __zz_cib_export
const __zz_cib_::__zz_cib_MethodTable* __zz_cib_decl __zz_cib_StdFunctionTests_GetMethodTable(std::uint32_t classId)
{
  switch(classId) {
  ...
  case __zz_cib_::__zz_cib_ids::__zz_cib_Class261::__zz_cib_classid:
