...
inline ::Geometry::Shape::_h_Shape* Geometry::Circle::__cast_to_Geometry__Shape(::Geometry::Circle::_h_Circle* h) {
	return _cib_::ShapeLib::CppToC::Geometry::Circle::instance().__cast_to_Geometry__Shape(h);
}
...
inline Geometry::Circle::Circle(int Ox, int Oy, int radius): Geometry::Shape(0) {
	__set(_cib_::ShapeLib::CppToC::Geometry::Circle::instance().__new(Ox, Oy, radius));
}

inline double Geometry::Circle::Area() const {
	return _cib_::ShapeLib::CppToC::Geometry::Circle::instance().Area(h_);
}

inline double Geometry::Circle::Perimeter() const {
	return _cib_::ShapeLib::CppToC::Geometry::Circle::instance().Perimeter(h_);
}

inline void Geometry::Circle::Draw(HDC hdc) const {
	_cib_::ShapeLib::CppToC::Geometry::Circle::instance().Draw(h_, hdc);
}
