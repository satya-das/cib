...
namespace __zz_cib_ { namespace Point {
	static ::Point* __zz_cib_decl __zz_cib_new_1(float x, float y) {
		return new ::Point(x, y);
	}
	static float __zz_cib_decl X_2(const ::Point* __zz_cib_obj) {
		return __zz_cib_obj->::Point::X();
	}
	static void __zz_cib_decl X_3(::Point* __zz_cib_obj, float x) {
		__zz_cib_obj->::Point::X(x);
	}
	static float __zz_cib_decl Y_4(const ::Point* __zz_cib_obj) {
		return __zz_cib_obj->::Point::Y();
	}
	static void __zz_cib_decl Y_5(::Point* __zz_cib_obj, float y) {
		__zz_cib_obj->::Point::Y(y);
	}
	static const ::Point* __zz_cib_decl __zz_cib_OperatorPlus_6(const ::Point* __zz_cib_obj, const ::Point& p) {
