...
namespace __zz_cib_ {
	namespace Graphics {
		namespace Circle { namespace __zz_cib_UnknownProxy {
			...
			public:
				Circle(__zz_cib_::__zz_cib_PROXY* proxy, __zz_cib_::__zz_cib_MethodTable mtbl, float Ox, float Oy, float radius)
		...
		namespace Circle {
			::Graphics::Circle* __zz_cib_decl __zz_cib_new_1(__zz_cib_::__zz_cib_PROXY* proxy, __zz_cib_::__zz_cib_MethodTable mtbl, float Ox, float Oy, float radius) {
...
namespace __zz_cib_ { namespace Graphics { namespace Circle {
	...
	__zz_cib_MethodTable __zz_cib_GetMethodTable()
	{
		...
		static const __zz_cib_MethodEntry methodTable[] = {
			...
			(__zz_cib_MethodEntry) &CreateCircle_5,
			(__zz_cib_MethodEntry) &__zz_cib_delete_6,
			(__zz_cib_MethodEntry) &__zz_cib_cast_to___Graphics__Shape_7,
