...
namespace __zz_cib_ { namespace Graphics { namespace LogContext { namespace __zz_cib_GenericProxy {
	...
	public:
		...
		void Line(float x1, float y1, float x2, float y2) override {
			...
			auto method = getMethod<LineProc>(__zz_cib_GenericProxy::__zz_cib_methodid::Line_1);
		...
		void Rect(float l, float b, float r, float t) override {
			...
			auto method = getMethod<RectProc>(__zz_cib_GenericProxy::__zz_cib_methodid::Rect_2);
		...
		void Circle(float cx, float cy, float r) override {
			...
			auto method = getMethod<CircleProc>(__zz_cib_GenericProxy::__zz_cib_methodid::Circle_3);
		...
		void Ellipse(float cx, float cy, float a, float b) override {
			...
			auto method = getMethod<EllipseProc>(__zz_cib_GenericProxy::__zz_cib_methodid::Ellipse_4);
...
namespace __zz_cib_ { namespace Graphics { namespace LogContext {
	...
	static void __zz_cib_decl __zz_cib_delete_3(::Graphics::LogContext* __zz_cib_obj) {
		delete __zz_cib_obj;
	}
	static void __zz_cib_decl Line_4(::Graphics::LogContext* __zz_cib_obj, float x1, float y1, float x2, float y2) {
		__zz_cib_obj->::Graphics::LogContext::Line(x1, y1, x2, y2);
	}
	static void __zz_cib_decl Rect_5(::Graphics::LogContext* __zz_cib_obj, float l, float b, float r, float t) {
		__zz_cib_obj->::Graphics::LogContext::Rect(l, b, r, t);
	}
	static void __zz_cib_decl Circle_6(::Graphics::LogContext* __zz_cib_obj, float cx, float cy, float r) {
		__zz_cib_obj->::Graphics::LogContext::Circle(cx, cy, r);
	}
	static void __zz_cib_decl Ellipse_7(::Graphics::LogContext* __zz_cib_obj, float cx, float cy, float a, float b) {
...
namespace __zz_cib_ { namespace Graphics { namespace LogContext {
	__zz_cib_MethodTable __zz_cib_GetMethodTable() {
		...
		static const __zz_cib_MethodEntry methodTable[] = {
			...
			reinterpret_cast<__zz_cib_MethodEntry> (&Rect_5),
			reinterpret_cast<__zz_cib_MethodEntry> (&Circle_6),
			reinterpret_cast<__zz_cib_MethodEntry> (&Ellipse_7),
