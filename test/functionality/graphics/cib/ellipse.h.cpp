...
namespace __zz_cib_ {
	namespace Graphics {
		namespace Ellipse { namespace __zz_cib_UnknownProxy {
			...
			public:
				Ellipse(__zz_cib_::__zz_cib_PROXY* proxy, __zz_cib_::__zz_cib_MethodTable mtbl, float Ox, float Oy, float a, float b)
		...
		namespace Ellipse {
			::Graphics::Ellipse* __zz_cib_decl __zz_cib_new_1(__zz_cib_::__zz_cib_PROXY* proxy, __zz_cib_::__zz_cib_MethodTable mtbl, float Ox, float Oy, float a, float b) {
