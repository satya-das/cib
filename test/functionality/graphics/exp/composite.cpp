...
namespace __zz_cib_ { namespace Graphics { namespace Composite { namespace __zz_cib_Generic {
	...
	public:
		...
		float Area() const override {
			...
			auto method = __zz_cib_get_mtable_helper().getMethod<AreaProc>(__zz_cib_methodid::Area_7);
			return method(__zz_cib_h_);
		}
		float Perimeter() const override {
			using PerimeterProc = float (__zz_cib_decl *) (__zz_cib_HANDLE*);
			auto method = __zz_cib_get_mtable_helper().getMethod<PerimeterProc>(__zz_cib_methodid::Perimeter_8);
			return method(__zz_cib_h_);
		}
		void Draw(::Graphics::Context* ctx) const override {
			using DrawProc = void (__zz_cib_decl *) (__zz_cib_HANDLE*, __zz_cib_HANDLE* ctx);
			auto method = __zz_cib_get_mtable_helper().getMethod<DrawProc>(__zz_cib_methodid::Draw_9);
...
namespace __zz_cib_ { namespace Graphics { namespace Composite {
	...
	static void __zz_cib_decl __zz_cib_delete_4(::Graphics::Composite* __zz_cib_obj) {
		delete __zz_cib_obj;
	}
}}}
