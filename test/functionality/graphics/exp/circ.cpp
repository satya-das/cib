...
namespace __zz_cib_ { namespace Graphics { namespace Circle {
	float __stdcall Area_1(::Graphics::Circle* __zz_cib_obj) {
		return __zz_cib_obj->Area();
	}
	float __stdcall Perimeter_2(::Graphics::Circle* __zz_cib_obj) {
		return __zz_cib_obj->Perimeter();
	}
	void __stdcall Draw_3(::Graphics::Circle* __zz_cib_obj, __zz_cib_::HANDLE* ctx) {
