...
namespace __zz_cib_ { namespace Graphics { namespace Ellipse {
	float __zz_cib_decl Area_1(::Graphics::Ellipse* __zz_cib_obj) {
		return __zz_cib_obj->Area();
	}
	float __zz_cib_decl Perimeter_2(::Graphics::Ellipse* __zz_cib_obj) {
		return __zz_cib_obj->Perimeter();
	}
	void __zz_cib_decl Draw_3(::Graphics::Ellipse* __zz_cib_obj, __zz_cib_::HANDLE* ctx) {
