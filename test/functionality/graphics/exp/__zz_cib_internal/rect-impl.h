	...
	namespace __zz_cib_ { namespace Graphics {
		namespace Rectangle {
			class __zz_cib_Helper {
				...
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_new_1(::Graphics::Rectangle* __zz_cib_proxy, float left, float bottom, float right, float top) {
					using __zz_cib_newProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (::Graphics::Rectangle*, __zz_cib_::__zz_cib_MethodTable, float left, float bottom, float right, float top);
			...
			private:
				...
				__zz_cib_Helper() {
					mtbl = __zz_cib_Graphics_GetMethodTable(__zz_cib_::Graphics::__zz_cib_classid::__Graphics__Rectangle);
				}
			...
			public:
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::Rectangle* __zz_cib_obj) {
					return __zz_cib_obj->__zz_cib_h_;
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::Rectangle& __zz_cib_obj) {
					return __zz_cib_obj.__zz_cib_h_;
				}
				static ::Graphics::Rectangle* __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE* h) {
					return new ::Graphics::Rectangle(h);
				}
				::Graphics::Rectangle& __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(&h);
				}
				::Graphics::Rectangle const * __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE* h) {
					return __zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(h));
				}
				::Graphics::Rectangle const & __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(&h));
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_release_handle(::Graphics::Rectangle* __zz_cib_obj) {
