...
namespace __zz_cib_ { namespace Graphics { namespace Rectangle {
	...
	private:
		...
		static float Area_2(__zz_cib_HANDLE* __zz_cib_obj) {
			...
			auto method = instance().getMethod<AreaProc>(__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::Area_2);
		...
		static float Perimeter_3(__zz_cib_HANDLE* __zz_cib_obj) {
			...
			auto method = instance().getMethod<PerimeterProc>(__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::Perimeter_3);
			return method(__zz_cib_obj);
		}
		static void Draw_4(__zz_cib_HANDLE* __zz_cib_obj, __zz_cib_HANDLE* ctx) {
			...
			auto method = instance().getMethod<DrawProc>(__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::Draw_4);
			return method(__zz_cib_obj, ctx);
		}
		static __zz_cib_HANDLE* __zz_cib_new_5(::Graphics::Rectangle* __zz_cib_proxy, const __zz_cib_HANDLE& __zz_cib_param0) {
			...
			auto method = instance().getMethod<__zz_cib_newProc>(__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::__zz_cib_new_5);
		...
		static void __zz_cib_delete_6(__zz_cib_HANDLE* __zz_cib_obj) {
			if (__zz_cib_obj) {
				...
				auto method = instance().getMethod<__zz_cib_deleteProc>(__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::__zz_cib_delete_6);
				return method(__zz_cib_obj);
			}
		}
...
inline Graphics::Rectangle::Rectangle(const ::Graphics::Rectangle& __zz_cib_param0)
	: Rectangle(__zz_cib_::Graphics::Rectangle::__zz_cib_Helper::__zz_cib_new_5(this, *__zz_cib_::Graphics::Rectangle::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
...
inline Graphics::Rectangle::~Rectangle() {
	...
	__zz_cib_::Graphics::Rectangle::__zz_cib_Helper::__zz_cib_delete_6(h);
}
