...
namespace __zz_cib_ { namespace Point {
	...
	private:
		...
		static float X_3(__zz_cib_HANDLE* __zz_cib_obj) {
			...
			auto method = instance().getMethod<XProc>(__zz_cib_methodid::X_3);
			return method(__zz_cib_obj);
		}
		...
		static float Y_5(__zz_cib_HANDLE* __zz_cib_obj) {
			...
			auto method = instance().getMethod<YProc>(__zz_cib_methodid::Y_5);
			return method(__zz_cib_obj);
		}
		...
		static __zz_cib_HANDLE* __zz_cib_OperatorPlus_7(__zz_cib_HANDLE* __zz_cib_obj, const __zz_cib_HANDLE& p) {
			...
			auto method = instance().getMethod<__zz_cib_OperatorPlusProc>(__zz_cib_methodid::__zz_cib_OperatorPlus_7);
		...
		static __zz_cib_HANDLE* __zz_cib_OperatorMinus_8(__zz_cib_HANDLE* __zz_cib_obj, __zz_cib_HANDLE* p) {
			...
			auto method = instance().getMethod<__zz_cib_OperatorMinusProc>(__zz_cib_methodid::__zz_cib_OperatorMinus_8);
			return method(__zz_cib_obj, p);
		}
		__zz_cib_Helper()
