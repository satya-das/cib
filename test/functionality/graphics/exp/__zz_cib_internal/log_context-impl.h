	...
	namespace __zz_cib_ { namespace Graphics {
		namespace LogContext {
			class __zz_cib_Helper {
				...
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_new_1(::Graphics::LogContext* __zz_cib_proxy) {
					using __zz_cib_newProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (::Graphics::LogContext*, __zz_cib_::__zz_cib_MethodTable);
				...
				static void __zz_cib_delete_2(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					if (__zz_cib_obj) {
				...
				static void Line_3(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj, float x1, float y1, float x2, float y2) {
					using LineProc = void (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE*, float x1, float y1, float x2, float y2);
					auto proc = getProc<LineProc>(__zz_cib_::Graphics::LogContext::__zz_cib_methodid::Line_3);
					return proc(__zz_cib_obj, x1, y1, x2, y2);
				}
				static void Rect_4(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj, float l, float b, float r, float t) {
					using RectProc = void (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE*, float l, float b, float r, float t);
					auto proc = getProc<RectProc>(__zz_cib_::Graphics::LogContext::__zz_cib_methodid::Rect_4);
					return proc(__zz_cib_obj, l, b, r, t);
				}
				static void Circle_5(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj, float cx, float cy, float r) {
					using CircleProc = void (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE*, float cx, float cy, float r);
					auto proc = getProc<CircleProc>(__zz_cib_::Graphics::LogContext::__zz_cib_methodid::Circle_5);
					return proc(__zz_cib_obj, cx, cy, r);
				}
				static void Ellipse_6(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj, float cx, float cy, float a, float b) {
					using EllipseProc = void (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE*, float cx, float cy, float a, float b);
				...
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_cast_to___Graphics__Context_7(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					using __zz_cib_cast_to___Graphics__ContextProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE* h);
			...
			private:
				...
				__zz_cib_Helper() {
					mtbl = __zz_cib_Graphics_GetMethodTable(__zz_cib_::Graphics::__zz_cib_classid::__Graphics__LogContext);
				}
...
static _ProcType getProc(std::uint32_t procId) {
			...
			public:
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::LogContext* __zz_cib_obj) {
					return __zz_cib_obj->__zz_cib_h_;
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::LogContext& __zz_cib_obj) {
					return __zz_cib_obj.__zz_cib_h_;
				}
				static ::Graphics::LogContext* __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE* h) {
					return new ::Graphics::LogContext(h);
				}
				::Graphics::LogContext& __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(&h);
				}
				::Graphics::LogContext const * __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE* h) {
					return __zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(h));
				}
				::Graphics::LogContext const & __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(&h));
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_release_handle(::Graphics::LogContext* __zz_cib_obj) {
