...
namespace __zz_cib_ { namespace Graphics { namespace LogContext {
	...
	private:
		...
		static void Line_3(__zz_cib_HANDLE* __zz_cib_obj, float x1, float y1, float x2, float y2) {
			...
			auto method = instance().getMethod<LineProc>(__zz_cib_methodid::Line_3);
		...
		static void Rect_4(__zz_cib_HANDLE* __zz_cib_obj, float l, float b, float r, float t) {
			...
			auto method = instance().getMethod<RectProc>(__zz_cib_methodid::Rect_4);
		...
		static void Circle_5(__zz_cib_HANDLE* __zz_cib_obj, float cx, float cy, float r) {
			...
			auto method = instance().getMethod<CircleProc>(__zz_cib_methodid::Circle_5);
		...
		static void Ellipse_6(__zz_cib_HANDLE* __zz_cib_obj, float cx, float cy, float a, float b) {
			...
			auto method = instance().getMethod<EllipseProc>(__zz_cib_methodid::Ellipse_6);
		...
		static __zz_cib_HANDLE* __zz_cib_cast_to___Graphics__Context_7(__zz_cib_HANDLE* __zz_cib_obj) {
			...
			auto method = instance().getMethod<__zz_cib_cast_to___Graphics__ContextProc>(__zz_cib_methodid::__zz_cib_cast_to___Graphics__Context_7);
			return method(__zz_cib_obj);
		}
		__zz_cib_Helper()
...
inline Graphics::LogContext::LogContext(const ::Graphics::LogContext& __zz_cib_param0)
	: LogContext(__zz_cib_::Graphics::LogContext::__zz_cib_Helper::__zz_cib_copy_0(this, *__zz_cib_::Graphics::LogContext::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
