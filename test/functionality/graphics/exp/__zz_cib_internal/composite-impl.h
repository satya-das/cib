...
namespace __zz_cib_ { namespace Graphics { namespace Composite {
	...
	private:
		...
		static __zz_cib_HANDLE* __zz_cib_copy_1(::Graphics::Composite* __zz_cib_proxy, const __zz_cib_HANDLE& __zz_cib_param0) {
			using __zz_cib_copyProc = __zz_cib_HANDLE* (__zz_cib_decl *) (::Graphics::Composite*, __zz_cib_MethodTable, const __zz_cib_HANDLE& __zz_cib_param0);
...
inline Graphics::Composite::Composite(const ::Graphics::Composite& __zz_cib_param0)
	: Composite(__zz_cib_::Graphics::Composite::__zz_cib_Helper::__zz_cib_copy_1(this, *__zz_cib_::Graphics::Composite::__zz_cib_Helper::__zz_cib_handle(__zz_cib_param0)))
{}
