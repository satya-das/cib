	...
	namespace __zz_cib_ { namespace Graphics {
		namespace Circle {
			class __zz_cib_Helper {
				...
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_new_1(::Graphics::Circle* __zz_cib_proxy, float Ox, float Oy, float radius) {
					using __zz_cib_newProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (::Graphics::Circle*, __zz_cib_::__zz_cib_MethodTable, float Ox, float Oy, float radius);
					auto proc = getProc<__zz_cib_newProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::__zz_cib_new_1);
				...
				static float Area_2(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					...
					auto proc = getProc<AreaProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::Area_2);
				...
				static float Perimeter_3(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					...
					auto proc = getProc<PerimeterProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::Perimeter_3);
					return proc(__zz_cib_obj);
				}
				static void Draw_4(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj, __zz_cib_::__zz_cib_HANDLE* ctx) {
					...
					auto proc = getProc<DrawProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::Draw_4);
					return proc(__zz_cib_obj, ctx);
				}
				static __zz_cib_::__zz_cib_HANDLE* CreateCircle_5(float Ox, float Oy, float radius) {
					using CreateCircleProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (float Ox, float Oy, float radius);
					auto proc = getProc<CreateCircleProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::CreateCircle_5);
					return proc(Ox, Oy, radius);
				}
				static void __zz_cib_delete_6(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					if (__zz_cib_obj) {
						using __zz_cib_deleteProc = void (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE*);
						auto proc = getProc<__zz_cib_deleteProc>(__zz_cib_::Graphics::Circle::__zz_cib_methodid::__zz_cib_delete_6);
						return proc(__zz_cib_obj);
					}
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_cast_to___Graphics__Shape_7(__zz_cib_::__zz_cib_HANDLE* __zz_cib_obj) {
					using __zz_cib_cast_to___Graphics__ShapeProc = __zz_cib_::__zz_cib_HANDLE* (__zz_cib_decl *) (__zz_cib_::__zz_cib_HANDLE* h);
					auto proc = (__zz_cib_cast_to___Graphics__ShapeProc) instance().mtbl[__zz_cib_::Graphics::Circle::__zz_cib_methodid::__zz_cib_cast_to___Graphics__Shape_7];
					return proc(__zz_cib_obj);
				}
			private:
				__zz_cib_::__zz_cib_MethodTable mtbl;
				__zz_cib_Helper() {
					mtbl = __zz_cib_GraphicsLib_GetMethodTable(__zz_cib_::GraphicsLib::__zz_cib_classid::__Graphics__Circle);
				}
			...
			public:
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::Circle* __zz_cib_obj) {
					return __zz_cib_obj->__zz_cib_h_;
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_handle(const ::Graphics::Circle& __zz_cib_obj) {
					return __zz_cib_obj.__zz_cib_h_;
				}
				static ::Graphics::Circle* __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE* h) {
					return new ::Graphics::Circle(h);
				}
				::Graphics::Circle& __zz_cib_from_handle(__zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(&h);
				}
				::Graphics::Circle const * __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE* h) {
					return __zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(h));
				}
				::Graphics::Circle const & __zz_cib_from_handle(const __zz_cib_::__zz_cib_HANDLE& h) {
					return *__zz_cib_from_handle(const_cast<__zz_cib_::__zz_cib_HANDLE*>(&h));
				}
				static __zz_cib_::__zz_cib_HANDLE* __zz_cib_release_handle(::Graphics::Circle* __zz_cib_obj) {
				...
				static void __zz_cib_release_proxy(::Graphics::Circle* __zz_cib_obj) {
					if (__zz_cib_obj->__zz_cib_h_) {
						...
						auto proc = (__zz_cib_release_proxyProc) instance().mtbl[__zz_cib_::Graphics::Circle::__zz_cib_methodid::__zz_cib_release_proxy_8];
