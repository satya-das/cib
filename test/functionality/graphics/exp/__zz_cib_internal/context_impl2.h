	...
	namespace __zz_cib_ { namespace Graphics {
		namespace Context {
			class __zz_cib_Helper {
				...
				static __zz_cib_::HANDLE* __zz_cib_new_6(::Graphics::Context* __zz_cib_proxy) {
			...
			public:
				...
				::Graphics::Context& __zz_cib_from_handle(__zz_cib_::HANDLE& h) {
					return *__zz_cib_from_handle(&h);
				}
				::Graphics::Context const * __zz_cib_from_handle(const __zz_cib_::HANDLE* h) {
