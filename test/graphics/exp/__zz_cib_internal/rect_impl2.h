		...
		namespace Rectangle { class __zz_cib_Helper {
			...
			static void __zz_cib_delete_7(__zz_cib_::HANDLE* __zz_cib_obj) {
				if (__zz_cib_obj) {
					...
					auto proc = (__zz_cib_deleteProc) instance().mtbl[__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::__zz_cib_delete_7];
					return proc(__zz_cib_obj);
				}
			}
		...
		public:
			...
			static void __zz_cib_release_proxy(::Graphics::Rectangle* __zz_cib_obj) {
				if (__zz_cib_obj->__zz_cib_h_) {
					...
					auto proc = (__zz_cib_release_proxyProc) instance().mtbl[__zz_cib_::Graphics::Rectangle::__zz_cib_methodid::__zz_cib_release_proxy_6];
...
inline Graphics::Rectangle::~Rectangle() {
	...
	__zz_cib_::Graphics::Rectangle::__zz_cib_Helper::__zz_cib_delete_7(h);
}
